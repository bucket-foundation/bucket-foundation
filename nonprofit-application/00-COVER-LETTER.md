...
**Date:** 2026-04-14
**To:** Prospective fiscal sponsor (Open Collective Foundation / Code for Science & Society / Software Freedom Conservancy / equivalent)

---

Dear Sponsor Review Committee,

I am writing to apply for fiscal sponsorship of **bucket.foundation**, an open-source research-data protocol and reference site whose mission is to make primary research **paid-for-once and citeable-forever**, and to route citation revenue to authors instead of publishers.

**Status of the project.** bucket.foundation began as an independent prototype in late 2024 and went dormant in February 2025. It has been **reactivated in April 2026** as an open-source-first project under an MIT-licensed reference implementation and a CC0-in-intent protocol specification. The reactivation is documented at <https://github.com/gianyrox/bucket-foundation>. We are now seeking a fiscal sponsor so the project can:

1. Receive tax-deductible donations and grants under a recognized 501(c)(3) (or equivalent) umbrella.
2. Hold the operating wallet, the domain `bucket.foundation`, and the trademark in a non-personal legal vehicle.
...
| File | What it is |
|---|---|
| `00-COVER-LETTER.md` | This letter |
| `01-APPLICATION.md` | Master application form (reusable across sponsors) |
| `02-NARRATIVE.md` | Mission, activities, public-benefit narrative |
| `03-BUDGET.md` | 12-month projected budget |
| `04-BOARD-AND-GOVERNANCE.md` | Governance structure & founding maintainer |
| `05-CONFLICT-OF-INTEREST-POLICY.md` | Adopted COI policy |

...
| **Prior status** | None. There is no lapsed entity to "reinstate" in the strict legal sense. The word *reinstated* in this packet refers to **reinstating the project as an active nonprofit effort** after a 14-month dormancy. No struck-off corporation is being revived. |

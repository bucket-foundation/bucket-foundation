...
def _cmd_run(args: argparse.Namespace) -> int:
    ...
    config = {
        ...
        "writeback_signoff": args.signoff,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    run_p.add_argument("--signoff", default=None, help="named human approver identity; required with --writeback (PLAN.md section 10, GOVERNANCE.md)")

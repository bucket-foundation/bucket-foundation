...
| x402-research-gateway | ✅ public code (gianyrox/x402-research-gateway), compiles | **Not hosted anywhere.** No agent can pay the rail. |
...
## Bucket Foundation repo

### bkt-cont-01 · P2 · CONTRIBUTING.md for external devs
Two contribution paths: (1) code PRs to the Next.js site, (2) canon submissions via Story Protocol IP NFT mint. Doc setup (`npm i`, `npm run dev`, env vars for Dynamic/Supabase/Story), canon submission criteria (axioms/laws/primary derivations only), MIT/CC0 licensing expectations. Link from README.
...
## Longtermism / Deep-History / Biophysics Research Track
...
### bkt-research-04 · P2 · Canon dossier: melanin as biological semiconductor
...
### bkt-research-05 · P2 · Canon dossier: mitochondria primary science
...
### bkt-research-06 · P2 · Canon dossier: peptide science primary literature
Foundation-tier peptide literature: Khavinson epithalon/bioregulators, BPC-157 mechanism, MOTS-c (Lee et al), GHK-Cu (Pickart), SS-31 (Szeto), TB-500/thymosin-β4, semax/selank (Russian primary lit). Mechanism of action only. Dosing, clinical, and commercial material is out of scope. Lives in canon; separate from peptide-markets landscape bead.

### bkt-research-07 · P3 · Landscape: RUO peptide marketplace scan
Index research-use-only peptide vendor landscape as situational awareness. **This is neither a buyer's guide nor canon.** Scope: vendor list, COA practices, RUO regulatory framing, pricing trends, geographic distribution. Output: `research-landscape/peptide-markets/` (outside `bucket-canon/`). **Explicit non-facilitation clause**: Bucket indexes information about the market, does not enable purchase or use. Read-only scraping, no account creation, no transactions.
...
### bkt-research-09 · P4 · Shelf: longtermism philosophy
...
## Figures / Religion / Ancient Sites / Becker Research Track

Second batch, filed same session. Canon/landscape split continues.

### bkt-research-10 · P2 · Polymath register
...
### bkt-research-11 · P3 · Polyglot register
...
### bkt-research-12 · P3 · Landscape: history commentariat
...
New canon branch `09-sacred-texts` for primary religious/philosophical texts (treated as primary sources under the same discipline as Euclid; truth claims are out of scope). PD/open-license seed sources:
...
### bkt-research-14 · P3 · Landscape: comparative mythology / cataclysm motifs
Cross-cultural flood/fire/sky-change motifs: Sumerian, Hebrew, Greek, Hindu, Mesoamerican, Aboriginal, Native American. Secondary scholarship: Dumézil, Eliade, Campbell, de Santillana & von Dechend (*Hamlet's Mill*, precession-encoded myth). Analytical landscape tier. Canon promotion is out of scope.
...
### bkt-research-17 · P1 · Robert O. Becker complete dossier
...
3. **Books** (bibliographic, link to WorldCat):
...
### bkt-research-18 · P3 · Bioelectric lineage dossier
...
1. Pipeline from batch 1 (`bkt-research-01`), then everything else opens up
...
**Build stats**: 1 commit pending. 8 new directories under bucket-canon/ + research-landscape/. 12 new README/INDEX/SEED files. 1 site mirror (419 MB, uncommitted, will evaluate.gitignore).

---

## Art / Design / Music Research Track
...
### bkt-research-20 · P2 · Canon dossier: Bauhaus + design-theory primaries
...
### bkt-research-21 · P2 · Canon dossier: music-theory primaries
...
### bkt-research-22 · P3 · Landscape: art market
"What the rich buy", primary data sources only, non-facilitation. Art Basel/UBS Global Art Market Report (McAndrew), Artprice, Artnet, TEFAF Report, Sotheby's Mei Moses indices (Mei & Moses 2002 AER), Christie's/Sotheby's/Phillips/Bonhams post-sale results, Ashenfelter & Graddy 2003 JEP, Goetzmann/Renneboog/Spaenjers Art and Money 2011, freeport/tax-haven mechanics, FATF 2023 money-laundering report. Landscape map. Purchase guidance is out of scope.

### bkt-research-23 · P3 · Landscape: art education + "how to be artistic"
Beaux-Arts → Bauhaus → Black Mountain → RISD/Cooper Union/CalArts/Goldsmiths pedagogical lineage. Classical drawing primaries: Bargue Drawing Course, Loomis, Nicolaides Natural Way to Draw, Hale Drawing Lessons from the Great Masters. Creative-practice popularizers: Cameron The Artist's Way, Tharp The Creative Habit, Kleon Steal Like an Artist, Rubin The Creative Act (landscape tier). Art-education research: Eisner, Robinson. Creativity research (borderline canon): Csikszentmihalyi Flow/Creativity, Simonton on genius, Amabile componential theory, peer-reviewed primaries promote to 07-mind/creativity/ later.

### bkt-research-24 · P4 · Landscape: contemporary-art commentariat
Parallel to history-commentariat. Critics: Greenberg, Rosenberg, Krauss, Foster, T.J. Clark, Fried, Berger (Ways of Seeing), Hickey, Hughes (Shock of the New). Contemporary: Saltz, Smith, Schjeldahl (†), Davis. Market-adjacent: Georgina Adam, Schachter, Reyburn. Podcast/YT: Great Art Explained, The Art Angle, Dialogues (Zwirner). <!-- voice-ignore-line: proper name (critic Hal Foster) -->
...
## Activity Layer / "What's New" Beads
...
`tools/feed/feed.py`. Rolling main feed `feed.json` (last 200 events, at repo root) + monthly archives `feed/YYYY-MM.json`. RSS/Atom emitter `feed.xml`. Schema versioned; events are append-only; retractions are appended as new events.
...
Extend existing CONTRIBUTING.md (or create): explicit PR acceptance criteria per tier. Canon = primary source cited (DOI or permanent URL), branch-fit justified, no marketing voice, no clinical claims in mechanism dossiers, canon_score > 50 when pipeline-resolvable. Landscape = tier labeled, evaluation axes filled, non-endorsement framing. Figures = SCHEMA.md compliance, Disputed. Paragraph for contested claims. Quote the editorial constraints from SCHEMA.md verbatim.

### bkt-feed-07 · P4 · Story Protocol mint-on-merge hook
...
### bkt-site-refactor-01 · P2 · Canon site refactor

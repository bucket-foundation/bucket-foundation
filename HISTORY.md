...
wired to the frame named **"publish"**. The frame named "discuss" got no wire.
...
- `build Profile` = a page profiling a theory
...
## The 2024 middle, bucket pitch

**File:** `zVwoR6s0FYawk1QY0GBIOe`
**Last modified:** 2024-01-17T12:02:59Z
**Status:** 344 top-level elements (mostly RECTANGLE/TEXT with few FRAMEs);
...
--slug bucket-pitch` to capture the full archive. That file is the
...
- **Outcomes ≠ canon.** Longevity, disease, cognition, energy, all
 downstream *applications*. Longevity research lives in
...
- **Absorption stage:** canon taxonomy is a working draft.
...
6. **"build the past"**, the first slogan. Retired in favor of
 the cleaner "build history" and then the bigger "renaissance"
 framing.

### The addition list

What is new in 2026 and has no 2022 precedent:

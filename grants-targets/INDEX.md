...
- Federal credibility opens up downstream private funders (Pew, Walton)
- DerbyFish has shipping product → fundable narrative today
...
**Recommendation: file all three SAM applications in week of 2026-05-04, regardless of which grants we submit.** Sunk-cost cheap (free), opens every federal program, has the longest lead time of any prep step.

Secondary gating risks:
- Bucket 501(c)(3) determination (3-9 months from filing Form 1023). HCB fiscal sponsorship gets us 80% of the way there for foundation grants but does NOT satisfy NSF prime-applicant rules.
...
4. **AGFarms (DerbyFish/Kala) → NOAA Saltonstall-Kennedy pre-proposal**, needs SAM; pre-proposal NOFO opens August. *Submit August 2026.*
...
2. **Week of 2026-05-11: Bucket onboards to HCB** (~1 week turnaround). Opens the Sloan / ESP / Gitcoin / Templeton / PL pathway today.
...
4. **Cultivate one NOAA Fisheries scientist** (regional NJ or FL office) starting May 2026. Letter of support de-risks every NOAA application. This is the highest-return cultivation move in the portfolio.
...
6. **MamaTeeTees needs cultivation.** Most West Africa funders are referral-only. Spend 2026 building relationships (Segal Africa Visionary network, Mastercard regional office, Cameroon-based advisors) and aim for 2027 application cycles.

## Cross-venture beads filed

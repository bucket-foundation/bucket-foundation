...
**Submitted to:** esp.ethereum.foundation
**Date:** 2026-05-04
**Applicant:** Gianangelo Dichio (individual, on behalf of bucket.foundation)
**Amount requested:** $30,000 – $300,000 USD-equivalent
...
- **Open contributor pool.** The contributor index (`canon-figures/`) seeds a pass-1 list of ~76 canon-tier figures across ten branches whose foundations the canon is built on; outreach for editorial and review collaboration is part of the funded work.
...
**M2 — Reference bucket hardened on Base mainnet (months 1–4).** Migrate the reference implementation from Base Sepolia to Base mainnet. Onboard the Story Protocol IP-NFT mint path for canon-tier artifacts. Operate a publicly available, zero-key, budget-capped agent proxy at `bucket.foundation/api/research` returning the feed402-compliant `{ data, citation, receipt }` envelope. Target: 1,000 canon-tier buckets across the seven foundation branches (mathematics, physics, chemistry, information & computation, biophysics, cosmology, mind) live and citeable.
...
| Audit / security review of the buyer wallet path | $15,000 | Required for mainnet migration |
...
— Gianangelo Dichio, gianyrox@gmail.com, github.com/gianyrox

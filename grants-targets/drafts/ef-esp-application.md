...
- [ ] **Name the smart-contract / wallet-path audit vendor** for the M2 mainnet migration line item, OpenZeppelin / Trail of Bits / Spearbit / Cantina. ESP reviewers ask. (~30 min, email two of them for a quote)
...
- [ ] **Verify the M2 target (1,000 buckets in 4 months)** is shippable given current canon-intake throughput, if not, drop to 250 and revise §4. (~20 min reality check)
...
Ecosystem Support Program Application.

## bucket.foundation

A Citation-Payment Public Good on Base.
...
| Documentation, conformance rig, transparency report | $10,000 | M1 + M4 deliverables |
| Contingency | $10,000 | |
| **Total (target ask)** | **$200,000** | Range $30K, $300K acceptable; scope adjusts proportionally |

We are willing to scope to any subset of the milestones at any award size in the $30K, $300K range. M1 alone (Protocol v1.0 + conformance rig + Base mainnet hardening) is feasible at the low end.
...
Gianangelo Dichio [[FOUNDER: confirm preferred citation form, match across all three grant drafts]], gianyrox@gmail.com, github.com/gianyrox [[FOUNDER: attach 1+ letter of support from a known x402 / Base / Coinbase Developer Platform contact, single highest-impact scoring lever on ESP]]

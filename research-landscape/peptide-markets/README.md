...
**Landscape tier. Read-only. Non-facilitation.**

## Purpose

Index the research-use-only (RUO) peptide vendor landscape as situational awareness for researchers working at the intersection of biophysics canon (`bucket-canon/05-biophysics/peptides/`) and real-world compound availability.
...
- A dosing / clinical-use reference
- A link aggregator to checkout pages
- A workaround for jurisdictional restrictions

## Explicit non-facilitation clause
...
- No account creation
- No transactions
- Public-pricing-page data only
- Vendor privacy respected (no scraping of customer reviews that contain PII)

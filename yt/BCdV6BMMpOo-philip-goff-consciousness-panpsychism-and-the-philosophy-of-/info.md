...
- **Video ID**: `BCdV6BMMpOo`
- **URL**: https://www.youtube.com/watch?v=BCdV6BMMpOo
- **Channel**: Lex Fridman — https://www.youtube.com/channel/UCSHZKyawb77ixDdsGog4iWA
- **Uploaded**: 20220203
- **Duration**: 2:46:31 (9991s)
- **Views**: 303388  ·  **Likes**: 5283
- **Captured**: 2026-05-10T18:16:09
...
EPISODE LINKS:
Philip's Twitter: https://twitter.com/Philip_Goff
Philip's Website: http://www.philipgoffphilosophy.com/
Galileo's Error (book): https://amzn.to/3ustY5B
Consciousness and Fundamental Reality (book): https://amzn.to/3ojldH1
...
- `0s` — Introduction
- `74s` — Conscious matter
- `2080s` — Death, mystical experiences and collective consciousness
- `2704s` — The authority of expertise
- `3960s` — Panpsychism and physics
- `5685s` — Suffering, zombies and illusion
- `7651s` — JRE podcast recap
- `8347s` — Free will
- `9406s` — Are we living in a simulation?
- `9637s` — Meaning of life

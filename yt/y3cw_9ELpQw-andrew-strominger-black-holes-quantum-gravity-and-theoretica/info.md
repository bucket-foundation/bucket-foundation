...
- **Video ID**: `y3cw_9ELpQw`
- **URL**: https://www.youtube.com/watch?v=y3cw_9ELpQw
- **Channel**: Lex Fridman — https://www.youtube.com/channel/UCSHZKyawb77ixDdsGog4iWA
- **Uploaded**: 20230215
- **Duration**: 2:19:34 (8374s)
- **Views**: 3011775  ·  **Likes**: 21631
- **Captured**: 2026-05-10T18:17:17
...
- `0s` — Introduction
- `72s` — Black holes
- `376s` — Albert Einstein
- `1544s` — Quantum gravity
- `1796s` — String theory
- `2444s` — Holographic principle
- `2921s` — De Sitter space
- `3233s` — Speed of light
- `3640s` — Black hole information paradox
- `4100s` — Soft particles
- `4647s` — Physics vs mathematics
- `5197s` — Theory of everything
- `6118s` — Time
- `6264s` — Photon rings
- `7205s` — Thought experiments
- `7706s` — Aliens
- `8044s` — Nuclear weapons

...
- **Video ID**: `jtMu-KFyKxM`
- **URL**: https://www.youtube.com/watch?v=jtMu-KFyKxM
...
- `0s` — Intro
- `66s` — Jack Kruse's background and medical journey
- `212s` — Decentralized medicine: what it means
- `560s` — Why centralized medicine is broken
- `679s` — The importance of circadian biology
- `1105s` — Bitcoin and time: connecting decentralized money to health
- `1391s` — "Bitcoin is a time machine": explained
- `2033s` — How sunlight and darkness affect health
- `2230s` — The role of technology in health outcomes
- `2588s` — Living a healthier, longer life: practical advice
- `2987s` — El Salvador: should Americans move there?
- `3449s` — Is bitcoin a time machine for everyone? Victor’s story
- `3673s` — The case for decentralizing your life

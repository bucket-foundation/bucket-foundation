...
- `0s` — Dr. John Kruse
- `131s` — Attention-Deficit/Hyperactivity Disorder (ADHD)
- `337s` — Genetics & Environment; COVID Pandemic & ADHD Diagnoses
- `703s` — Sponsors: Eight Sleep & Joovv
- `866s` — ADHD, Interest & Careers
- `1240s` — Social Media & Distractibility; ADHD & Lifespan Effect
- `1659s` — Hyperfocus, Flow States
- `2025s` — Tools: 4 Essential Behaviors for ADHD; Regular Meal Schedule
- `2466s` — Sponsor: AG1
- `2541s` — Tool: Regular Sleep Timing; Stimulants & Sleep
- `2886s` — Insomnia; Tools: Bedtime Structure, Exercise, Phones, Breathing
- `3150s` — Nighttime Waking Up; Cyclic Sighing
- `3395s` — Exercise; Addiction, Risk, Kids & Stimulants; Catecholamines & Focus
- `3872s` — Ritalin, Stimulants, Amphetamines; Amphetamine-Induced Psychosis & Risks
- `4606s` — Sponsor: LMNT
- `4683s` — Adult ADHD & Medications; Stimulants & Cardiovascular Risk?
- `5166s` — Adult ADHD Medication Choices, Psychosis, Cannabis
- `5629s` — ADHD Symptoms, Nicotine; Caffeine, Energy Drinks, L-Theanine
- `6208s` — Fish Oil, Cardiac Effects & ADHD, Tool: Fish Oil Dose, EPA vs DHA
- `6578s` — Sponsor: Mateina
- `6664s` — Gut Microbiome
- `6776s` — ADHD & Cognitive Behavioral Therapy (CBT), Tool: Task List System
- `7072s` — Video Games, Neurofeedback, ADHD Benefit?, Tool: Technology Restriction
- `7346s` — Guanfacine, Clonidine, Hypertension, Effects & Timeframe
- `7813s` — Modafinil, History & Forms, Dependence
- `8342s` — Drug Holidays; Short- vs Long-Acting Drugs, Addiction, Vyvanse
- `8936s` — Time Perception, ADHD, Circadian Rhythm Disruption, Phototherapy
- `9339s` — Zero-Cost Support, YouTube, Spotify & Apple Follow & Reviews, Sponsors, YouTube Feedback, Protocols Book, Social Media, Neural Network Newsletter

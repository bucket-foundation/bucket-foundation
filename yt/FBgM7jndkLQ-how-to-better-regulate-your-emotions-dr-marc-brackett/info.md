...
- **Video ID**: `FBgM7jndkLQ`
- **URL**: https://www.youtube.com/watch?v=FBgM7jndkLQ
- **Channel**: Andrew Huberman — https://www.youtube.com/channel/UC2D2CMWXMOVWx7giW1n3LIg
- **Uploaded**: 20260420
- **Duration**: 2:27:38 (8858s)
- **Views**: 144322  ·  **Likes**: 3539
- **Captured**: 2026-05-10T19:55:11
...
Academic Profile: https://medicine.yale.edu/profile/marc-brackett
...
Dealing with Feeling: https://amzn.to/48bJd68
Permission to Feel: https://amzn.to/48dkgaq
...
Dealing with Feeling podcast: https://www.youtube.com/playlist?list=PLRM-kVGeBRqdXAf7q7ut91HZQlfZSx_VX 
...
- `0s` — Marc Brackett
- `175s` — Emotion Regulation
- `353s` — Emotion Mindset, Anxiety; Good or Bad Emotions?
- `685s` — Sponsors: Joovv & Lingo
- `834s` — Permission for Happiness; Gender, Emotion Suppression
- `1333s` — Young Men, Vulnerability, Incapable; Gay Men
- `1860s` — Boys & Men, Crying; Emotion Socialization
- `2254s` — Sponsor: AG1
- `2338s` — Physical Interaction; Rough/Tumble Play, Teaching Emotion Regulation
- `2807s` — Emotion Calibration, Tools: Leaders & Being a Role Model; Meta-Moment
- `3375s` — Meditation & Stress Tolerance, Tool: Label Emotions; Childhood
- `3792s` — Sponsor: LMNT
- `3872s` — Understand Your Assumptions, Tool: Intentional Co-Regulation
- `4329s` — Vocabulary & Rethinking Emotion, Tool: Reframing
- `4549s` — Emotional Intelligence Training, Self-Evaluation
- `4935s` — Living with Discomfort & Emotional Intelligence
- `5221s` — Marc's Work & Criticism; Emotion "Leakage" & Switching Mindset
- `5659s` — Sponsor: Rorra
- `5732s` — Excitement, Positive Emotion; Modern Concerns, AI & Disconnection
- `6311s` — Major Societal Challenges & Everyday Progress
- `6878s` — Physical/Emotional Identity & Envision Best Self, Tool: Meta-Moment
- `7533s` — Emotional Intelligence
- `7966s` — Curiosity & Compassion; Reflection, Identity
- `8372s` — Point of Connection Game
- `8702s` — Zero-Cost Support, YouTube, Spotify & Apple Follow, Reviews & Feedback, Sponsors, Protocols Book, Social Media, Neural Network Newsletter

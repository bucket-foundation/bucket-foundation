...
- **Video ID**: `db-Xn2gzGxU`
- **URL**: https://www.youtube.com/watch?v=db-Xn2gzGxU
...
- `30s` — Daniel was home-schooled, allowed to study whatever he thought was most important
- `220s` — Daniel’s parents actually referred to his family as an “experiment”
- `364s` — By the time a child goes to school, civilization has already been imprinted on them
- `517s` — Daniel advocates that optimization is actually a part of the problem
- `794s` — Daniel details exactly why trying to optimize leads to serious problems
- `1120s` — Daniel talks about how to understand civilization’s history through game theory
- `1257s` — Some kinds of value can be extracted and lead to power, and other kinds can’t
- `1548s` — Daniel uses the example of COVID-19 to illustrate the problems with optimization
- `1841s` — How can we think in complex ways that respect the interconnected nature of existence
- `2139s` — It’s much easier to break things than it is to build complex systems
- `2296s` — Tom and Daniel discuss whether it’s possible to nudge people in the right direction
- `2761s` — Social media will lead us to war even though no one wants it
- `3072s` — Daniel and Tom discuss the connections between high school bullying and terrorism
- `3536s` — If you aren’t considering counter-responses, you are just being emotionally hijacked
- `3857s` — People’s minds are the battlefield
- `4199s` — There are no authorities that are trustworthy enough to just assume they are right
- `4515s` — Do you want to be effective or do you want to be right?
- `4785s` — Daniel explains how people become fundamentalist about things they are wrong about
- `5328s` — Debates are often not about understanding. They are just dogfights.
- `5523s` — Legitimate power is when I am trying to influence someone to be more self-directed
- `5735s` — Tom explains the relief of focusing on finding the right answers instead of being right
- `5995s` — If you want to be right, you are very easy to control. Fragile egos are vulnerable.
- `6153s` — Capitalism, the Trump campaign and Christianity have all been antifragile so far

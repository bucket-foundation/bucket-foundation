...
- **Video ID**: `dOJt-wFNe3E`
- **URL**: https://www.youtube.com/watch?v=dOJt-wFNe3E
- **Channel**: Chasing Consciousness Podcast — https://www.youtube.com/channel/UCOUJJsskobFdfaoZzAbE02Q
- **Uploaded**: 20250914
...
https://share.google/AHzwoM7Bel3ySia27 
...
- `0s` — Intro.
- `600s` — The role of electricity in nature.
- `925s` — The Earth has a negative charge & the ionosphere positive.
- `1140s` — The old consensus on water.
- `1380s` — Gilbert Ling - cellular water is charged and so the molecules stack.
- `1575s` — The transition of chemical structure when in contact with hydrophilic surfaces.
- `1665s` — Exclusion-Zone Water = Liquid Crystal Water.
- `1965s` — Changes chemical structure and electrical charge.
- `2100s` — Add light or electrons to build EZ Water.
- `2250s` — Grounding - is there any evidence?
- `2300s` — It’s an energy source, a battery charged by infared light.
- `2535s` — The difficulty raising money for ideas that go against the consensus.
- `2775s` — The threat to an old world view.
- `2910s` — The Brownian motion criticism of the data.
- `2940s` — Electrical energy generation in cells.
- `3360s` — The cardio vascular, blood flow energy issue.
- `3945s` — We’ve misunderstood membranes.
- `4380s` — The gel itself might be a barrier.
- `4440s` — Purification of water using the exclusion process.
- `4740s` — Difficulty getting business funding for the applications.
- `5040s` — Cancer cells have a lower negative charge. Perhaps a lack of EZ water.
- `5160s` — How information is stored in structured water.
- `5460s` — Luc Montagnier - water claims confirmed in 3 studies.
- `5940s` — Jacques Benveniste - dubbed ‘water memory’.
- `6030s` — Masero Emoto - Dean Radin confirmed his result.
- `6285s` — Non-verbal communication.

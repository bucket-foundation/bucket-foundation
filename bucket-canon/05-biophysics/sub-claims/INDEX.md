...
- [`001-audience-so-if-there-s-some-problem-with-the-quantum-mechani`](oxygen/001-audience-so-if-there-s-some-problem-with-the-quantum-mechani.md) — score=6 `00:33:38.720` — audience. So if there's some problem with the quantum mechanics here, like for example, most people don't even know that
- [`002-huge-amounts-of-oxygen-tension-in-a-cell-you-re-never-going-`](oxygen/002-huge-amounts-of-oxygen-tension-in-a-cell-you-re-never-going-.md) — score=6 `00:59:25.680` — huge amounts of oxygen tension in a Cell you're never going to be hypoxic well I want you to think about now biochemistr
- [`003-so-if-you-re-using-a-tool-that-doesn-t-measure-accurately-li`](oxygen/003-so-if-you-re-using-a-tool-that-doesn-t-measure-accurately-li.md) — score=6 `00:09:23.760` — so if you're using a tool that doesn't measure accurately like when somebody is 86 87% the doctor is trained from medica
- [`004-beginning-of-this-podcast-the-great-oxygenation-event-it-s-a`](oxygen/004-beginning-of-this-podcast-the-great-oxygenation-event-it-s-a.md) — score=6 `00:56:15.280` — beginning of this podcast the great oxygenation event it's a very interesting event so one of the things that's always f
...
- [`002-from-norcals-work-we-know-that-non-native-emf-and-blue-light`](blue-light/002-from-norcals-work-we-know-that-non-native-emf-and-blue-light.md) — score=6 `01:15:55.600` — from norcals work? We know that non-native EMF and blue light what's the fundamental thing they do? They cause a drop in
- [`003-red-light-is-the-antidote-to-blue-so-guess-what-in-the-sun-t`](blue-light/003-red-light-is-the-antidote-to-blue-so-guess-what-in-the-sun-t.md) — score=6 `01:24:31.280` — red light is the antidote to Blue so guess what in the sun that's behind me you never get Blue by itself you always get 
- [`004-blue-light-from-native-situation-meaning-the-sun-is-always-b`](blue-light/004-blue-light-from-native-situation-meaning-the-sun-is-always-b.md) — score=6 `00:13:28.640` — Blue light from native situation, meaning the sun, is always balanced by red. So, it turns out, guess what runs all the 
...
- [`001-dopamine-and-all-of-that-is-occurring-within-the-action-spec`](leptin/001-dopamine-and-all-of-that-is-occurring-within-the-action-spec.md) — score=6 `00:02:43.620` — dopamine and all of that is occurring within the action Spectra of sunlight I'd also love to learn from you about how ch
- [`002-of-the-prescription-that-i-wrote-20-years-ago-the-leptin-pre`](leptin/002-of-the-prescription-that-i-wrote-20-years-ago-the-leptin-pre.md) — score=6 `03:27:52.560` — of the prescription that I wrote 20 years ago the leptin prescription when you're in sunlight you don't need to eat food

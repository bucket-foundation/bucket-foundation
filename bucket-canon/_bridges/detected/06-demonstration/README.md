...
**Branches**: 02-physics · 03-chemistry · 05-biophysics · 06-cosmology · 07-mind
...
- **02-physics/feynman** — `showed me` — explanatory demonstration
- **02-physics/schrodinger** — `reaching the whole` — explanatory demonstration
- **03-chemistry/water-anomalies** — `demonstrate` — challenge to demonstrate water memory
- **05-biophysics/becker** — `take it to the next level` — missing link to Becker's work
- **06-cosmology/inflation** — `periodically in my student evaluations get told I'm one of Yale's harsher graders` — example of a challenging demonstration
- **07-mind/hegel** — `combines the abstract and the concrete` — explanatory demonstration of Hegel's philosophy
...
A demonstration can be tested by having multiple individuals arrive at the same conclusion through independent step-by-step explanation.


## Source claims (cluster members)

- [02-physics/feynman] Claim — Wheeler," he always called him Professor Wheeler.
- [02-physics/schrodinger] Claim — and I never had a conversation like that one teaching Schrodinger's equation you
- [03-chemistry/water-anomalies] Claim — eventually uh put up um an award of a million dollars to anybody who could gen w
- [05-biophysics/becker] Claim — correctly his students never took it to the next level I I give Albert St Georgi
- [06-cosmology/inflation] Claim — that is, I know I have the reputation, both because I periodically in my student
- [07-mind/hegel] Claim — But the one thing that's really striking about Hegel uh is that he combines the
...
### 0.840 · `_intake/claims-allbranch/curated-low/feynman/003-wheeler-he-always-called-him-professor-wheeler.md`
...
### 0.777 · `yt/p2J7wSuFRl8-1-course-introduction/transcript.txt`
...
### 0.774 · `yt/PTs--eFrzGo-greatest-mysteries-of-gravity-brian-greene-kip-thorne-world-/transcript.txt`
...
### 0.754 · `yt/PTs--eFrzGo-greatest-mysteries-of-gravity-brian-greene-kip-thorne-world-/transcript.txt`
...
### 0.751 · `yt/p2J7wSuFRl8-1-course-introduction/transcript.txt`
...
### 0.750 · `_intake/kruse-blog-corpus/articles/organizational-structural-failure-4-human-prions.md`
...
### 0.745 · `yt/mT7roDHocuc-5-the-idea-of-the-autonomous-artwork/transcript.txt`
...
### 0.738 · `yt/y1kafU4oODc-wittgenstein-drury-the-philosopher-and-the-psychiatrist/transcript.txt`
...
### 0.734 · `yt/qFuYUSWwn7s-when-physics-meets-fiction-brian-greene-dan-brown-world-scie/transcript.txt`

> He won&nbsp; the Presidential Award Mathematics. Would I know any of them? Probably not. I think you're thinking on a&nbsp; slightly different level than advanced calculus,&nbsp;&nbsp; which I think was the highest level he wrote at. Maybe I- Richard G. Brown, if you- I don't remember. It is going too far back. I don't think any of us can name the author&nbsp; of our high school textbooks. And I started,&nbsp;&nbsp; I just went into science. I&nbsp; just said this religion thing,&nbsp;&nbsp; I don't get it. I studied a lot of astronomy,&nbsp; studied a lot of physics, studied a lot of math. Th…

### 0.732 · `blog/plato-stanford-edu/reference.md`
...
### 0.731 · `yt/PTs--eFrzGo-greatest-mysteries-of-gravity-brian-greene-kip-thorne-world-/transcript.txt`
...
### 0.730 · `yt/uK2eFv7ne_Q-19-quantum-mechanics-i-the-key-experiments-and-wave-particle/transcript.txt`
...
### 0.729 · `yt/0nOtLj8UYCw-quantum-consciousness-debate-does-the-wave-function-actually/transcript.txt`
...
### 0.729 · `archive/inmemoriambyalfr00tennuoft/inmemoriambyalfr00tennuoft_djvu.txt`

> In October, 1828, he went to Trinity Colle^, Cambridge. There he soon became acquainted with the Tennysons, and thus began the ever- memorable friendship of which In Memoriam is the monument. Like his friends, he was the pupil of the Rev. William Whewell. The desul- tory nature of his acquirements forbade all hope of distinction in exam- inations, and he did not so much as attempt any Greek or Latin composition during his stay in the university. This was at first a disappointment to his father; but he gradually became reconciled to the evident bent of the young man's mind. Arthur paid no atten…

### 0.727 · `yt/FkYer0xP37E-stephen-wolfram-s-radical-theory-of-everything/transcript.txt`

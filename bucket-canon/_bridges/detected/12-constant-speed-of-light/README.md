...
**Branches**: 02-physics · 03-chemistry · 06-cosmology
...
**Category** (LLM judgment): primitive  ·  **Confidence**: 0.9
...
### 0.884 · `_intake/claims-allbranch/curated-low/einstein/009-inertial-frames.md`
...
### 0.864 · `_intake/claims-allbranch/curated-low/speed-of-light/003-don-t.md`
...
### 0.810 · `yt/t06aTX9jM34-decoding-the-universe-quantum-full-documentary-nova-pbs/transcript.txt`
...
### 0.797 · `yt/Qz_uYO6MvJ4-bergson-s-holographic-theory-25-pribram-bohm-short-revisit/transcript.txt`

> black you're in motion I'm at rest and my clocks are indeed simultaneous this is the framework from which it started in the Lorentz transformations were put in but if you just applied the Lorentz transformations outside of this framework you don't have any of this Shanahan says of the particles of waves quote time is retarding but no time is not retarding there is a slowing down due to velocity of physical processes by which we measure time it is a local time that is the processes in that clock there are slowing down if the clock is in motion at velocity V but STR is no physical explanation no…

### 0.794 · `_intake/kruse-blog-corpus/articles/ubiquitination-21-epi-onco-genesis.md`
...
### 0.790 · `yt/pHfFSQ6pLGU-12-introduction-to-relativity/transcript.txt`
...
### 0.789 · `yt/q95GYzJlyYY-werner-heisenberg-explains-time-like-you-ve-never-seen-befor/transcript.txt`
...
### 0.788 · `yt/t06aTX9jM34-decoding-the-universe-quantum-full-documentary-nova-pbs/transcript.txt`
...
### 0.788 · `blog/plato-stanford-edu/being-and-becoming-in-modern-physics.md`
...
### 0.787 · `yt/pHfFSQ6pLGU-12-introduction-to-relativity/transcript.txt`
...
### 0.785 · `yt/Hf1q-bZMEo4-what-are-traces-of-consciousness-a-new-breakthrough-unifying/transcript.txt`
...
### 0.783 · `_intake/claims-allbranch/curated-low/relativity/002-the-top-clock-always-has-to-run-faster-than-every-other.md`
...
### 0.782 · `yt/xaeafKPfs1M-the-greatest-discovery-about-reality-the-consciousness-behin/transcript.txt`
...
### 0.781 · `blog/plato-stanford-edu/bell-s-theorem.md`
...
### 0.781 · `yt/xaeafKPfs1M-the-greatest-discovery-about-reality-the-consciousness-behin/transcript.txt`

...
**Scope**: foundation-tier only. Memory systems — Scoville–Milner (patient H.M.); the founding declarative/procedural dissociation and hippocampal basis of episodic memory.
...
|---|---|---|---|
| LOSS OF RECENT MEMORY AFTER BILATERAL HIPPOCAMPAL LESIONS | `10.1136/jnnp.20.1.11` | 80 | CANON |

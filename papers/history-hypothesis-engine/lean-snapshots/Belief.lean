...
`IDEAL-STATE-AND-UNKNOWNS-SPEC.md` Section 2 replaces the single truth score
...
(`IDEAL-STATE-AND-UNKNOWNS-SPEC.md` Section 2): belief, disbelief, uncertainty
...
(`IDEAL-STATE-AND-UNKNOWNS-SPEC.md` Section 2). -/
...
(Josang's subjective logic; `IDEAL-STATE-AND-UNKNOWNS-SPEC.md` Section 3 pools
  ...
  if denom == 0 then
    ...
    { b := (omega1.b * omega2.u + omega2.b * omega1.u) / denom
      ...
      a :=
        ...
        else (omega1.a * omega2.u + omega2.a * omega1.u - (omega1.a + omega2.a) * omega1.u * omega2.u) / adenom }
...
theorem project_mem_unit (omega : OpinionQ)
    (hb : 0 <= omega.b) (hd : 0 <= omega.d) (hu : 0 <= omega.u) (hsum : omega.b + omega.d + omega.u = 1)
    (ha0 : 0 <= omega.a) (ha1 : omega.a <= 1) :
    0 <= projectQ omega /\ projectQ omega <= 1 := by
  show 0 <= omega.b + omega.a * omega.u /\ omega.b + omega.a * omega.u <= 1
  have hau0 : 0 <= omega.a * omega.u := Rat.mul_nonneg ha0 hu
  have hau1 : omega.a * omega.u <= 1 * omega.u := Rat.mul_le_mul_of_nonneg_right ha1 hu
  grind
...
`IDEAL-STATE-AND-UNKNOWNS-SPEC.md` Section 2's reading of a hypothesis nobody has

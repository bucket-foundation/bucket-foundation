...
`IDEAL-STATE-AND-UNKNOWNS-SPEC.md` §6b: "Good-Turing estimates the unseen
...
(`IDEAL-STATE-AND-UNKNOWNS-SPEC.md` §6b). `Rat`'s division convention
...
(`IDEAL-STATE-AND-UNKNOWNS-SPEC.md` §6b). The `f2 = 0` case falls back to

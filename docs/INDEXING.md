...
### P2
Backlinks drive indexation, run as content polish completes.
...
12. **Reddit**, r/DeSci, r/opensource, r/science (organic contributions only), one link + thoughtful comment thread

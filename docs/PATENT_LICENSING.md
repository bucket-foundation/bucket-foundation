...
3. **`/patents/insight` ($0.002/call)**, Bucket-derived analytics on the v1 corpus. WIPO PATENTSCOPE content can enter here under the derivative-license "added value" clause (insights are by definition derived rather than raw resale).
...
Defer until license budget approved.

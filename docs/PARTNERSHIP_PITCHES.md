...
## 2. Bio.xyz / BIO Protocol, highest return
...
4. Revenue routes to individual DAO treasuries rather than BIO Protocol itself (optics: "we back our DAOs").

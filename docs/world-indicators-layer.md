...
Outcome tier, outside the canon: per the canon thesis, world outcomes (obesity, GDP, emissions) are **downstream applications** of the foundations. This layer is earth-observation context for the canon, scoped to branch `10-earth`.

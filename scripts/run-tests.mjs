...
const SUITES = {
  unit: {
    files: [
      ...
      "scripts/test-academy-{engine,diagnostic,assess,mastery,tutor-route,tutor-client,answer-guard}.ts",
  ...
  db: {
    files: ["scripts/test-research-os-{evidence-append,evidence-admissions-db,connections-paging,access-paging,quote-receipts-db,read-access-routes,import-files-db,evidence-route-access,medallion-db,public-tables-deny-db,visible-select-db,history-db,llm-usage-db}.ts"],
  },
  "research-os": {
    files: [
    ...
    exclude: [
      "scripts/test-research-os-{dedup,merge-actions}.ts",
      "scripts/test-research-os-{evidence-append,evidence-admissions-db,connections-paging,access-paging,quote-receipts-db,read-access-routes,import-files-db,evidence-route-access,medallion-db,public-tables-deny-db,visible-select-db,history-db,llm-usage-db}.ts",
    ],
    commands: [

...
const SUITES = {
  ...
  db: {
    files: ["scripts/test-research-os-{evidence-append,evidence-admissions-db,connections-paging,access-paging,quote-receipts-db,read-access-routes,import-files-db,evidence-route-access,medallion-db,public-tables-deny-db,visible-select-db,history-db,history-import-db,history-review-db,history-regions-db,history-coverage-db,llm-usage-db,learn-events-db}.ts"],
  },
  "research-os": {
    files: [

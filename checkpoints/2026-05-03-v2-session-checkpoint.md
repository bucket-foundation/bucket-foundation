...
## TL;DR — what's ready, what needs review, what's pending

### ✅ Ready for the web (you can pick from these now)
...
### 👀 Needs founder review (in priority order)
...
### 🔧 Technical debt logged this session (for a separate `eai-` bead)
...
### Status of each plate (post-iteration)
...
| 09 | Phase portrait | ✅ ship-ready | iterated to use **normalized phase space** $(x, \dot{x}/\omega)$ — now true honest spirals |
...
## 2. The six bobber concepts (DALL-E 3, HD)
...
### Architecture in plain words (from founder, condensed)

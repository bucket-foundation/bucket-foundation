...
const COLUMNS = "id,lang,word,roman,gloss,root_lang,root_form,root_gloss,chain,root_texts,en_term,sense,confidence,root_confidence,root_source,root_gloss_form,root_gloss_confidence,source";

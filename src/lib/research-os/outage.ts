...
export const TRANSIENT_CODES: ReadonlySet<string> = new Set([
  ...
  // fix/ros-dropped-errors. Each is a read that did not finish this
  // minute, from a route that used to answer the same failure with an
  // empty result. Leaving them unclassified would have LoopPanel,
  // GraphMap, ClassesPanel and NodeView render them as "Research OS is

...
export const metadata = toolMetadata("figureminer");
    ...
    <main className="stone-bone relative grain">
      ...
      <div className="max-w-[900px] mx-auto px-4 md:px-6 py-14 md:py-32">
        ...
        <h1 className="font-display uppercase text-[clamp(1.75rem,4.5vw,3rem)] leading-[1.05] chisel tracking-[0.005em] text-[color:var(--basalt)]">
          mine{" "}
          <span className="inlay-gold">figures.</span>
        </h1>
        <p className="mt-6 text-[16px] leading-[1.75] text-[color:var(--basalt-2)] max-w-2xl">
          Paste a paper&apos;s text. FigureMiner extracts figure/table captions, reported statistics (p-values, n=, CIs, R²/r, mean±SD, fold-change), and unit-bearing measurements, and links the stats to each figure. Real, deterministic text mining — no GPU.
        </p>

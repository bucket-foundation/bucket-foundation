...
// This route must never be statically built or cached — the cookie gate
// is enforced per request by middleware.
    ...
    <main className="mx-auto max-w-3xl px-5 pb-24 pt-16 md:px-8 md:pt-24">
      <header className="mb-10 md:mb-14">
        ...
        <p
          ...
          style={{ color: "#8a867c", fontFamily: "var(--font-fraunces)", fontStyle: "italic" }}
        >
      ...
      <footer
        ...
        style={{ borderColor: "#1c1f22", color: "#7a7669", fontFamily: "var(--font-jetbrains)" }}
      >

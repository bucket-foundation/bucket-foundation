      ...
      <div className="z-30 w-full pt-4 md:pt-6 flex flex-col items-center gap-3 flex-shrink-0">
        ...
        {mode === "explore" ? (
          ...
          <div className="w-full max-w-2xl flex flex-col items-center gap-2 pointer-events-auto">
            ...
            <Legend min={0} max={100} avg={null} avgT={null} unit="composite score (0 to 100)" scoreMode />
          </div>
        )}
        ...
        <button
          ...
          title="The 5 longevity Blue Zones: biophysics ground truth to check the ranking against."
        >

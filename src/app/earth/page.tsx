...
export const metadata = {
  title: "Earth data globe",
  description:
    "211 countries, 32 development indicators. Explore one at a time or build a weighted target score, with the Blue Zones overlay as longevity ground truth. build history.",
};
      ...
      <header className="border-b hairline">
        <div className="max-w-6xl mx-auto px-4 md:px-6 pt-14 md:pt-24 pb-10 md:pb-16">
          ...
          <p className="mt-6 max-w-2xl text-[color:var(--parchment-dim)] text-pretty">
            ...
            direction-aware composite rank every nation from 0 to 100. The {zoneCount}{" "}
          ...
          <p className="mt-10 max-w-2xl text-[12px] text-[color:var(--parchment-dim)]">
            Outcomes such as longevity, health, and prosperity are downstream
            applications of the canon. This atlas is the eyeball test:
            does the target score land where people live longest?
          </p>
        </div>
      </header>

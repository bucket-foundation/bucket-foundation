...
_education-atlas `docs/landscape` analysis. Generated by [`analysis/landscape/build_access.py`](https://github.com/bucket-foundation/education-atlas/blob/main/analysis/landscape/build_access.py)
...
analytical frame this project defines in [`analysis/landscape/scale.py`](https://github.com/bucket-foundation/education-atlas/blob/main/analysis/landscape/scale.py). What is
...
Files: [`analysis/landscape/scale.py`](https://github.com/bucket-foundation/education-atlas/blob/main/analysis/landscape/scale.py) (constructed axes),

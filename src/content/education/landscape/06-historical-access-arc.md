...
[`analysis/landscape/build_historical.py`](https://github.com/bucket-foundation/education-atlas/blob/main/analysis/landscape/build_historical.py) → `results_historical.json`; figures by
...
Files: [`analysis/landscape/build_historical.py`](https://github.com/bucket-foundation/education-atlas/blob/main/analysis/landscape/build_historical.py) (analysis + era ledger),
...
[`analysis/landscape/build_historical.py`](https://github.com/bucket-foundation/education-atlas/blob/main/analysis/landscape/build_historical.py) + `make_figures_historical.py`.*

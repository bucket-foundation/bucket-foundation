...
And how education may need to change in the age of AI.

> **A note on stance.** This document is deliberately *neutral*. It maps a fast-moving and
> contested field rather than a program for any one route through it. The serious expert
...
> form before placing it beside its rivals. The reader will not find a verdict. The
> conclusion is that the evidence is early, mixed, and funded or framed by interested
> parties, and that distinguishing **hype from evidence from unknown** is the single most
...
## 1. The assessment rupture: cheating

Detection, and the swing back to the room.
...
A B-grade essay in thirty seconds, the take-home essay no longer measures the student. It
...
leaders believe cheating has increased since generative AI became available, with 21% saying
it increased "a lot"**
...
It is important to hold this: *perception* of more cheating is not the same as *measured*
More cheating, and some pre-AI baseline of academic dishonesty was already high. What changed
unambiguously is that the marginal cost and effort of producing a convincing fake fell to near zero.

### 1.2 Why detection does not work

And harms equity when it is trusted.
...
- **Major institutions have responded by switching detection off.** Vanderbilt, Yale, Johns
 ...
 imperfect but structurally untenable, since paraphrasing tools defeat detectors while the
...
in-class data," "make them critique the AI's output." Some of these raise the cost of
cheating. But, as one-shared critique put it, much of this is **"lies we tell ourselves":**
...
The position is that there is no fully AI-proof unsupervised assessment, only supervised
assessment and assessment redesigned so that AI *use* is part of what's being evaluated.

---

## 2. The tutoring and personalization promise, graded
...
### 2.2 What the effect-size evidence says

The grading starts by deflating the 2-sigma figure itself. Bloom's result rested on **two
...
Two sigma was likely a ceiling produced by ideal conditions rather than a reliable expectation. For
...
### 2.3 The generative-AI tutoring evidence: early, promising, contested

The new evidence concerns LLM-based tutors. The most-cited result is a **World Bank
randomized controlled trial in Edo State, Nigeria** (Benin City, nine public schools, six weeks of
after-school sessions using Microsoft Copilot/GPT-4 for English). The headline, repeated, was
that students achieved learning gains "that take two years." The underlying number is
more modest and more useful: **0.31 SD on the combined assessment (0.23 SD on English)**,
...
academy platform** rather than Khanmigo: e.g., an India RCT (~5,500 students, 74 schools)
...
RCT of AI tutoring in UK classrooms reported it "can safely and support students"
([arXiv:2512.23633](https://arxiv.org/pdf/2512.23633)), but described itself as exploratory.

**Bottom line for section 2:** The personalization promise is plausible and has early
Support, in under-resourced settings where the counterfactual is *no* tutoring. It is
...
## 3. What AI can and cannot do for learning
...
- **Reliability / hallucination.** LLMs fluently assert false things, wrong citations, invented
 ...
 incompetent one, because novices cannot detect the error (the thing they lack is
...
- **Gerlich (2025), *Societies***, a survey-and-interview study (n≈666) found a **strong negative
 ...
 ([SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5082524)). It is
 **correlational**, it cannot show AI *causes* lower critical thinking rather than weaker critical
 thinkers leaning on AI more., **higher education appeared protective**: degree-holders
...
- **MIT Media Lab, "Your Brain on ChatGPT" (Kosmyna et al., 2025).** An EEG study (n=54) of essay
 ...
 [arXiv:2506.08872](https://arxiv.org/abs/2506.08872)). This study went viral and is
 over-read. It is **small-n, unreviewed at release, and has drawn a formal critique** of its
 EEG methodology and reproducibility ([arXiv:2601.00856](https://arxiv.org/abs/2601.00856)). It is
 suggestive and short of dispositive.

The synthesis: there is converging *early* evidence, across correlational, qualitative, and
...
## 4. The skills question: if AI can write

Code, and summarize, what should humans learn?

If machines now do the canonical outputs of education, what is left to teach? The serious answers
conflict.

**Position A, Foundational knowledge matters *more* in the AI era (the cognitive-science camp).**
...
metacognitive-laziness research shows, is that the tool meant to support this may be the thing
...
or replaces human instruction. The technology itself does not settle it.

---

## 6. Policy

The teacher's changing role, and the spectrum of "how education must change".
...
between schools that integrate and schools that prohibit, has repeated.
...
**human-centred**, calls on governments to **regulate** (data-privacy standards, ethical
Validation, teacher training), and **recommends a minimum age of 13 for independent use of
...
### 6.3 The structuralist reframing: AI as a flashlight
...
*assessment and credentialing system* was always the weak point, and AI forced the issue.
...
*Strength:* about near-universal use; teaches judgment; preserves most of the existing system.
...
*Strength:* attacks the actual root cause; improves validity regardless of AI; aligns
...
assessment.
*Strength:* if the tutoring evidence holds and scales, the largest potential upside, for
Under-resourced and developing-world settings (the Nigeria signal).
*Cost:* the strongest evidence (section 2) is still early, short-term, and facilitated rather
...
What is evidence, what is unknown.
...
- LLM tutors can produce meaningful gains (Nigeria 0.31 SD; Ghana), but short-term,
 facilitated, single-context, persistence unknown.
...
- The long-run cognitive effect on a generation that learns *with* AI from the start, the deskilling
 studies test adults retrofitting AI rather than children raised on it.
- Whether AI nets out as leveler or divider, this appears to be a policy outcome rather than a fixed

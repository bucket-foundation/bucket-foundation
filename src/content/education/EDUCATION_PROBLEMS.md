# The Global Education Problem Atlas

### Bucket Foundation's founding problem statement

Grounded in authoritative data.

_education-atlas v0.1.0, generated from the World Bank EdStats, UNESCO UIS,
our World in Data, and OECD PISA 2022. Every number here is a row in
...
evidence is opinion. The evidence is here: what the educational
problems are, by country, by level, measured against the global
standard (UN Sustainable Development Goal 4, *Quality Education*), drawn from the
authoritative custodians of education data.
...
### The access crisis has shrunk but not closed

And it has moved up a level.
...
*actionable* finding in the atlas: financing is a policy lever governments control.
...
What this atlas does *not* capture.

A founding problem statement that overclaims is worse than none. The
...
latest-available country values summed together, for the same reason. No global
...
*purpose* of education itself. These are real, central, and flagged here

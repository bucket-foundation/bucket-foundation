...
> **pgvector RPC on that schema, not a parallel service**. pgvector 0.8.0 is
...
> curated **45k** subset *now* with genuine cross-lingual vector results. The
...
## Switching the explorer from the subset to the full index (follow-up)

...
## Why a contributor index
Not just a citation graph.
...
- **Contributor indexes** rank by **contribution to foundations**, above citation count. A figure with one paper that founded a discipline outranks a figure with a thousand papers that refined it.
...
The contributor index is built in **passes** over time. Each pass is logged in `_pass-log.md`.
...
The seed pass is the floor, well below the ceiling. If a branch you care about looks thin, that means it gets the next pass. Open an issue or just say *"go deep on tradition"* and the next pass will 5x that branch.

## Editorial principles

1. **Foundation over biography.** A card explains what the figure built that became canon. It stays well short of a Wikipedia article. Personal life, political views, anecdotes, out, unless they directly explain the foundation.
2. **Contribution over centrality.** A figure with one foundation outranks a figure with a thousand refinements. Centrality (how many people cited them) is a downstream metric, well below a canon-tier signal.
3. **Diverse traditions.** The canon spans traditions well beyond Western Europe. Greek, Arab, Persian, Indian, Chinese, African, and Indigenous traditions all built foundations. The seed pass is deliberately spread across traditions, weighted toward none.
...
5. **Cards are short on purpose.** ~250 words each. Density beats length. A card is a *contact card*, well short of an essay.
...
7. **No living-figure cards in the seed pass.** Living figures (Penrose, Witten, Chomsky, Hawking before 2018, Margulis before 2011) need a higher bar of editorial care to avoid hagiography. Pass 1 includes a few unambiguous ones; pass 2+ will broaden.

...
the daughter of a Königsberg merchant and was, by Hilbert's own report, the parent who
introduced him to mathematics, astronomy, and prime numbers as a child. He was the elder
...
Königsberg when he was eight); Hilbert and Minkowski had known each other since
gymnasium days. The three formed what historians of the Göttingen school later called
...
years. The course notes, taken by students and circulated in mimeograph, are an entire
secondary literature in themselves; many were edited and published in the 1990s by
William Ewald, Michael Hallett, Ulrich Majer, and the Hilbert-Edition project at
Göttingen.

Minkowski died unexpectedly on 12 January 1909 from a perforated appendix, at the age
of forty-four. Hilbert delivered the memorial address at the Göttingen Akademie in
April 1909; it is one of the few occasions on which his prose drops the technical
register, and the loss of Minkowski is one of the two events that visibly marked his
later life (the other being the dispersal of the institute in 1933). Klein died in
1925. Of the original Göttingen circle Hilbert was alone in the senior chairs by the
mid-1920s, and the institute he had built was already passing in working leadership to
Courant, Landau, Noether, Hermann Weyl (who had returned in 1930 to take Hilbert's chair
on his retirement), and the younger generation.
...
Weyl had been Hilbert's preferred successor for a decade. Hilbert remained in Göttingen
as *Emeritus*, kept an office at the institute, and continued to attend the colloquium
and to advise students for as long as the institute existed in a recognizable form.

The Nazi *Machtergreifung* of 30 January 1933 ended the Göttingen institute as a
working centre within six months. The Civil Service Restoration Law of 7 April 1933
forced the dismissal of Jewish or politically suspect academic appointees. Among those
who lost their positions or were forced into exile in the months that followed: Emmy
Noether (dismissed April 1933, emigrated to Bryn Mawr); Richard Courant (dismissed,
emigrated to NYU 1934, where he founded what is now the Courant Institute); Paul
Bernays (Hilbert's working collaborator on the foundations programme, lost his
*Privatdozent* status as a Swiss Jew, returned to the ETH Zürich); Edmund Landau
(boycotted by Nazi student organizations led by Oswald Teichmüller in November 1933,
forced into early retirement, died 1938); Felix Bernstein, Otto Neugebauer, Paul
Hertz, and Hans Lewy among others. Max Born (formally a Göttingen experimental physics
appointment but tightly tied to Hilbert's institute as a postdoc in the 1920s) was
dismissed and emigrated to Edinburgh.

Hilbert was seventy-one in 1933, *Emeritus*, with no administrative power and no
political organization to back him. He protested individual cases in writing where he
could; the surviving correspondence shows him writing to the Education Minister and to
Göttingen colleagues on behalf of dismissed staff. He refused to leave Göttingen
himself. The famous exchange with Bernhard Rust, the Reich Minister for Science,
...
Bunsenstrasse continued under Helmut Hasse as director from 1934, with a much-reduced
staff and a research programme aligned where it had to be with the regime's demands;
Weyl had emigrated in 1933 to the Institute for Advanced Study at Princeton. Hilbert
saw fewer visitors as the war approached. He fell on the streets of Göttingen in late
1942 and broke his arm; he never recovered fully and died on 14 February 1943 at age
eighty-one. The funeral on 18 February 1943 was attended, by the contemporary
recollection of Arnold Sommerfeld (who travelled from Munich) and the contemporary
report in the local Göttingen press, by approximately twelve people. The institute that
had once trained the dominant generation of twentieth-century mathematicians and
physicists buried its founder with a quorum that would have been an embarrassment for a
...
fully formal axiomatization in which the words *point*, *line*, and *plane* could in
principle be replaced by *table*, *chair*, and *beer mug* (Hilbert's own jest, recorded
by Otto Blumenthal) without altering a single proof. Twenty axioms organized into five
groups (incidence, order, congruence, parallels, continuity) generate, with
...
Second International Congress of Mathematicians, set out twenty-three problems that
Hilbert proposed as a research programme for the new century. Ten were presented orally;
...
the strategy is impossible: any consistent formal system rich enough to encode
elementary arithmetic cannot prove its own consistency by means encodable within the
...
Hilbert proved the result by an existence argument that did not produce the generators
explicitly: from any infinite system of forms one can extract a finite basis, by a
...
The 1897 *Zahlbericht* (*Die Theorie der algebraischen Zahlkörper*, the "report on
numbers" commissioned by the Deutsche Mathematiker-Vereinigung) is the synthesizing
treatise of late-nineteenth-century algebraic number theory: ideal theory in the manner
of Dedekind and Kronecker, the law of quadratic and higher reciprocity, ramification,
class-field theory in embryo. It served as the standard reference for the next thirty
years; nearly every twentieth-century algebraic number theorist learned the subject
either from it or from a textbook derived from it. Hilbert's own subsequent papers on
class-field theory (the so-called "Hilbert class field," whose existence and properties
...
Neumann's *Mathematische Grundlagen der Quantenmechanik* (1932) is the canonical
exposition, written explicitly within the Hilbert framework Hilbert had developed for
integral equations a quarter-century earlier and re-axiomatized by von Neumann a few
...
3. **Grundlagen der Geometrie**, Teubner, Leipzig, 1899 (first edition; the
   *Festschrift* for the unveiling of the Gauss, Weber memorial in Göttingen). Tenth
   ...
   most-cited English version, though it does not include the later supplements).
...
8. **Grundzüge der theoretischen Logik**, with Wilhelm Ackermann, Springer, 1928.
   Second edition 1938; English translation of the second edition: *Principles of
   Mathematical Logic*, ed. Robert E. Luce, Chelsea, 1950. The textbook in which the
   *Entscheidungsproblem* is first posed precisely.
...
11. **Grundlagen der Mathematik**, with Paul Bernays. Vol. 1, Springer, 1934; Vol. 2,
    Springer, 1939. The technical companion to the Hilbert programme. Largely the work
    of Bernays on Hilbert's behalf and under Hilbert's direction; the substantive
...
## 4. What Hilbert got wrong

### The Hilbert programme

The central error is the one Hilbert himself acknowledged, in private, in the years
after 1931. The programme as set out in 1922 and 1928 required a finitary consistency
proof of classical arithmetic and, by extension, of analysis and set theory. Gödel's
1931 paper *Über formal unentscheidbare Sätze der Principia Mathematica und verwandter
Systeme I* established that no consistent formal system $S$ rich enough to encode
elementary arithmetic can prove its own consistency by means formalizable within $S$. The
finitary methods Hilbert wished to use are by any reasonable reading a sub-system of
arithmetic, and the second incompleteness theorem applies. Within five years of 1931
the programme as Hilbert formulated it was understood, by Hilbert's own logicians
(Bernays, von Neumann, Ackermann), to be impossible in its original sweep.

The qualifications matter. Gentzen's 1936 consistency proof for Peano arithmetic, using
transfinite induction up to $\epsilon_0$, is finitary in the sense that it manipulates
...
The reaction is not as well documented as one would wish. Von Neumann (who learned of
Gödel's result first, at Königsberg in September 1930, and worked through the
implications immediately) reportedly described Hilbert's response as one of *visible
...
omission shaped the field's research priorities for a generation: foundational work on
...
men behaved badly and that Hilbert's institutional power made his bad behaviour more
consequential.
...
The Hilbert *Ahnentafel* in the Mathematics Genealogy Project lists 76 doctoral
students, an exceptionally large number for any twentieth-century mathematician. The
following are the figures whose work is itself canon- or near-canon-tier and whose
relationship to Hilbert is well documented:
...
five days earlier. This raw chronology generated, almost from the moment of
publication, a question about scientific priority: did Hilbert get the field equations
first?
...
limited by the institutional powerlessness of an *Emeritus*. He did not publicly resign
in protest, did not emigrate, did not make a public denunciation; the question whether
he should have done so is a question every senior German academic of 1933 had to answer
for himself. Reid's biography (1970) treats the answer charitably; later assessments
(Segal, *Mathematicians under the Nazis*, 2003) are more critical of the Göttingen
faculty as a whole while singling Hilbert out for the personal interventions he did
make.
...
- **Niedersächsische Staats- und Universitätsbibliothek Göttingen, Handschriften und
  Seltene Drucke**, *Nachlass David Hilbert*. The master archive: approximately 250
...
- **Deutsches Museum, Munich**, scattered Hilbert materials in the Sommerfeld and
  Born papers.
- **The Mathematics Genealogy Project** (North Dakota State University) maintains the
  authoritative Hilbert *Ahnentafel* of doctoral students.

---

## 9. Indispensable secondary literature

- **Constance Reid, *Hilbert*, Springer, 1970; corrected reprint with foreword by
  Freeman Dyson, Springer, 1996.** The standard biography. Reid was a non-mathematician
  (sister of the logician Julia Robinson) who interviewed Courant, Bernays, Weyl, and
  surviving Göttingen students directly; the book is closer to oral history than to
  archival reconstruction and is the better for it. The Göttingen-1933 chapters and
  the Rust exchange come through Courant's testimony.
...
- **Michael Hallett, *Cantorian Set Theory and Limitation of Size*, Oxford, 1984**, and
  ...
  2004 onward). The standard scholarly treatments of Hilbert's foundational thought
  and its development from the 1890s lectures.
- **Michael-Wolfgang Toepell, *Über die Entstehung von David Hilberts "Grundlagen der
  Geometrie"*, Vandenhoeck & Ruprecht, 1986.** The reconstruction, from the lecture
  notes, of the path from Hilbert's 1891 *Projektive Geometrie* lectures to the 1899
  axiomatic *Grundlagen*.
- **William Ewald (ed.), *From Kant to Hilbert: A Source Book in the Foundations of
  Mathematics*, Oxford, 2 vols., 1996.** The English-language source book that places
  Hilbert in the late nineteenth-century foundational debate with Dedekind, Cantor,
  Frege, Poincaré, and Brouwer.
- **Benjamin H. Yandell, *The Honors Class: Hilbert's Problems and Their Solvers*, A K
  Peters, 2002.** The accessible problem-by-problem account of the 1900 list.
- **Sanford Segal, *Mathematicians under the Nazis*, Princeton, 2003.** The critical
  history of the German mathematical community under National Socialism; Hilbert
  appears throughout, primarily in the chapters on Göttingen and on Bieberbach's
  *Deutsche Mathematik* counter-movement.
- **Dirk van Dalen, *Mystic, Geometer, and Intuitionist: The Life of L. E. J.
...
- **The Göttingen 1928 ICM speech.** Hilbert opened the Bologna ICM in 1928 with a
  speech welcoming back the international community after the post-war boycott of
  German mathematicians. Brouwer led a German nationalist counter-faction urging a
  boycott of Bologna in protest. The speech itself survives; the precise sequence of
  events around the Brouwer faction's pressure on Hilbert is less than fully clear in
  the surviving correspondence.
- **The Franz Hilbert diagnosis.** Schizophrenic-spectrum is the modern best guess;
  the contemporary diagnoses (psychosis, dementia praecox) are not equivalent
  categories and the medical records, if they survive at all, are not in the open
  archive.
...
- **Funeral attendance.** The number "twelve" is from contemporary recollection
  ...
  as six and as high as twenty. The point of the figure is not the precise count; it
  is the order of magnitude.

---

## 11. The polymath question

Hilbert is a borderline polymath case in the strict register of this index, and the
borderline case is worth working through rather than asserting.
...
accounting, of the same order of magnitude as his single best paper.
...
late old age; the colleagues he had spent thirty years assembling were driven out or
killed; his closest intellectual friend died at forty-four; his only child was
ill from adolescence; he died with twelve mourners in a country that had repudiated
the kind of mathematics he had spent his life building. None of this changes what the
work is. The work is the foundations on which most of twentieth-century mathematics
rests. The headstone in the Stadtfriedhof Göttingen still reads *Wir müssen wissen.
Wir werden wissen.*
...
`polymath-borderline` `01-mathematics` `02-physics-cross` `04-information-cross`
`foundations-of-mathematics` `axiomatic-method` `grundlagen-der-geometrie`
`hilbert-problems` `hilbert-programme` `formalism` `proof-theory` `metamathematics`
`invariant-theory` `algebraic-number-theory` `zahlbericht` `integral-equations`
`hilbert-space` `general-relativity-cross` `einstein-hilbert-action`
`gottingen-institute` `1862-1943` `königsberg` `göttingen` `germany`
`weimar-republic` `nazi-period-victims-protected` `noether-protector`
`courant-collaborator` `bernays-collaborator` `gödel-refuted`

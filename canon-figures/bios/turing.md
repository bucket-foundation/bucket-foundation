...
| **lifespan** | 23 June 1912 – 7 June 1954 <!-- voice-ignore-line: bibliographic citation, dates/abbreviations preserved verbatim --> |
...
the human anchor of what is now called the Church-Turing thesis: a meta-mathematical
identification of the informal notion *effectively calculable* with the formal <!-- voice-ignore-line: "effectively calculable" is the standard historical term of art from computability theory, not a filler adverb -->
notion *Turing-machine-computable* (equivalently
...
formal system matter (Wittgenstein: not; Turing: bridges fall down). In
...
they were working on, only the abstract questions adjacent to it. In
...
different from, the von Neumann *First Draft of a Report on the
EDVAC* (June 1945, on which Turing drew but which he extended in
British-engineering directions, including a much more aggressive
...
question of whether it ** thinks is an empirically empty one. The paper
...
"Turing test" quotes; the paper's actual content is more careful than
...
ignored for a decade, picked up cautiously in the 1960s by
...
is said to have liked), has been the standard one for half a
century.

It is, on the available evidence, unsettled. Jack Copeland's 2012
...
considers it unlikely. The current summary is: the cyanide is certain;
...
note from 2021. The mythologization of his life since the 1980s
...
*calculable* and *Turing-computable* are the same notion) cements
...
*machine*, ahead of the formal system, and because the mechanical-procedure framing
...
when the diffusion constants of the species differ sufficiently
...
behavioural-indistinguishability to understanding; Block's
...
For the 1936 paper, the indispensable companion is Charles
...
All of theoretical computer science. To pick out only the
...
## 6. What Turing Got Wrong

**The 1952 model is qualitative ahead of quantitative.** Turing's reaction, diffusion
...
, including non-linear analyses, finite-domain effects, and
...
an ill-formed question, short of a metaphysical definition of mind. The
...
not behaviourally consistent with active suicidal ideation. The summary
...
expense of Welchman, Tutte, Newman, Flowers, and the Wrens who ran the
machines. Turing's contribution is foundational; it is one of
several foundational contributions, ahead of the whole of the wartime
achievement.
...
- **B. Jack Copeland (ed.), *Colossus: The Secrets of Bletchley Park's
  ...
  and Colossus did and for situating Turing's contribution within
...
This is an omission of substance, ahead of a placement question. Turing 1952 is the founding

...
Editorial conventions inherited from `SCHEMA.md`: no marketing voice, no anachronisms, every claim auditable to a primary source or a peer-reviewed secondary, disputed attribution flagged inside the file rather than excluded. Sections on what the figure got wrong are required; hagiography is a defect.

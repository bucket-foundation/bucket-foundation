...
> **A derived view over `figures.json`, standing alongside the branch files.** This file lists figures whose canonical contribution is **load-bearing in ≥3 canon branches** (`branches` + `cross_branches`, combined, distinct, length ≥ 3).
>
...
| Einstein | 02-physics | 06-cosmology, 01-mathematics | Special and general relativity (physics), the 1917 cosmological model with Λ (cosmology, founding paper of relativistic cosmology), and the propagation of Ricci, Levi-Civita tensor calculus into physics through Einstein, Grossmann 1913 and the 1916 *Grundlage* (math, cross-link only, adoption and propagation rather than invention). |
...
| Leibniz (NOT YET IN INDEX, pass-3 candidate) | - | - | Flagged: calculus, binary arithmetic, monadology, theodicy, qualifies; add in a future pass. |

---

## What this register is not

- This excludes "great minds" lists. A encyclopedic figure whose contributions are compilational does not qualify.
- This excludes popularity indexes. Living-figure polymath claims require **documented foundation-tier contribution in each claimed branch**, beyond a career summary.
- This file is regenerated. When a figure is added, removed, or re-scoped in `figures.json`, regenerate this file from the data.

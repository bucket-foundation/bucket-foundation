...
- 2015 (Nov, same PRL issue) — Independent photon experiment, ~7σ — Shalm, Nam et al. (NIST Boulder) — third platform, same conclusion — T2 PRL 115, 250402 (2015)
- 2016–2017 — Ion (Rosenfeld/Weinfurter, 398 m) and further photon tests tighten statistics — T2
- 2018 (May) — Cosmic Bell test uses light from stars (and, in the BIG Bell Test, ~100,000 human volunteers generating bits) to choose measurement settings, pushing the settings' causal origin back centuries/light-years and closing the **freedom-of-choice** loophole — Handsteiner et al.; BIG Bell Test Collaboration — T2 PRL 118, 060401 (2017); Nature 557, 212 (2018)

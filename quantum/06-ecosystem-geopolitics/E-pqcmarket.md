...
- [T5] **"PQC migration solutions":** ~$15.0B (2025) → ~$86.5B (2034), CAGR ~22% (MarketIntelo). Broadest definition — folds in consulting + managed services; the outlier high end.
...
- https://marketintelo.com/report/post-quantum-cryptography-pqc-migration-solutions-market

...
- [T3] Jiuzhang 4.0 claims sampling advantage ~10^54 over classical — USTC (claimed; boson-sampling advantage claims have historically eroded under classical spoofing — see S-bench)
...
- China is building domestic dilution-fridge, laser, and cryo supply to route around export controls (see E-export, E-supplychain).

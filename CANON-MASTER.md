...
The seven-branch grid is pedagogical. The actual structure is in the bridges
...
- Rovelli ↔ Smolin: ~85 each direction (mutual)
- Hameroff → Penrose: 86 (Orch-OR)
- Greene/Vafa/Maldacena → Witten: 75-85 (string theory canonical ancestor)
...
Newton, Maxwell, Faraday, Tesla, Einstein, Bohr, Heisenberg, Schrödinger,
Pauli, Born, Planck, Dirac, Feynman, Weinberg, Gell-Mann, Yang, Wheeler,
Penrose, Hawking, Hameroff, Witten, Vafa, Maldacena, Strominger, Greene,
Rovelli, Smolin, Sakharov, Linde, Guth, Tegmark, Thorne, Sachdev, Randall,
Arkani-Hamed, Bohm, Bell, Aspect, Zeilinger, Everett, Pribram, Sheldrake,
Faggin.

### Mathematics

Russell, Whitehead, Wittgenstein, Gödel, Hilbert, Poincaré, Cantor, Riemann,
Gauss, Galois, Noether, Boole, De Morgan, Laplace, Lagrange, Euler, Weyl,
von Neumann, Turing, Wiles, Perelman, Tao, Villani, Mirzakhani, Arnold,
Gromov, Grothendieck, Friedrichs, Conway.

### Mind/philosophy

James, Bergson, Husserl, Heidegger, Merleau-Ponty, Kierkegaard, Schelling,
Hegel, Schopenhauer, Plato, Aristotle, Aquinas, Augustine, Spinoza,
Marcus Aurelius, Peirce, Quine, Putnam, Kuhn, Popper, Lakatos, Feyerabend,
Hacking, Kripke, Davidson, Lewis, Plantinga, Rorty, Nussbaum, Strawson,
Kastrup, Hoffman, Chalmers, Dennett, Friston, Seth, Tononi.

### Biology

Darwin, Wallace, Mendel, Watson, Crick, Franklin, Chargaff, Krebs, Loewi,
Sanger, Prusiner, de Duve, Tsien, Karplus, Mayr, Dobzhansky, Lorenz,
Tinbergen, Wilson, Gould, McClintock, Pribram.

### Cybernetics / Information / AI

Wiener, McCulloch, Pitts, von Foerster, Turing, Shannon, Chaitin, Kolmogorov,
Wolfram.

## What's still under-indexed
...
`/canon/claims`, `/canon/claims/[concept]`, `/canon/claims/[concept]/[slug]`,
`/canon/graph`.

...
**The missing ideas are intermediate ideas.** Asked for base ideas, the proposer named what the graph lacks one step down: convolution, flux, the Gamma function, vector spaces with bases and inner products. A few reach the bottom: time as a physical parameter, propositions as objects, the law of bivalence (named twice), natural numbers, units and dimensions, and functions of a real variable name semantic primes or foundations. The head-noun hint flags 10, 8 of them base ideas; the misses are two function names, convex functions and the Gamma function. Each missing idea carries a one-sentence definition.

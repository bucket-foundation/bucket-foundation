...
3. Fix `nonprofit-application/00-COVER-LETTER.md` and any other file still naming HCB or the dissolved Open Collective Foundation as a candidate sponsor, per `00-BASE-INFO-MEMO.md` gaps G-6 and the HCB finding in section 1 above, before either cover letter goes to a real sponsor.

...
- `duolingo-lesson-reward.mp4` (≈4 min, **founder-recorded**, automation is anti-bot-blocked), a real logged-in lesson end to end: word-bank exercise, **green "Correct!" feedback**, the **score reveal**, the **lesson-complete stats animation**, and the **streak-goal commitment**. The animations we couldn't automate.
...
### Duolingo lesson + reward, key frames
...
**Contrast w/ ours:** every rep ends in an **immediate, animated reward**; ours has no reward moment. And the exercise is **word-bank assembly** (recognition-assisted) rather than our **blank typed recall**.

### Duolingo onboarding, every step
...
**The crux for our language fix:** Duolingo's *first* rep is a **3-image multiple-choice you cannot fail**; our language deck's first rep is **cold typed recall** ("type 0"). That single difference is most of why ours "feels confusing."
...
| file | screen | the gap |
|---|---|---|
| `ours/m-00-first.png` | onboarding welcome | a **6-slide intro carousel** (telling) instead of do-the-first-atom |
| `ours/clean-10-home.png` | home (Biophysics) | **menu of concepts + Study&Learn** instead of a computed "Today's Route" |
| `ours/clean-30-lang-card.png` | "Study & learn" view | **reading-first** (LESSON/PLAIN/CORE/DEEP) ahead of retrieval-first |

### map/duolingo/

Duolingo onboarding funnel.
...
| **Khan** | free | ✅ **Complete**, exercise + "Not!" feedback + hint + streak/level chrome (`map/khan-exercise/`) |
...
| **Apple HIG / Whop** | - | ✅ principles in `UX-CASE-STUDIES.md` (design refs only) |

All **free** case studies are complete. Paid platforms intentionally left at landing-level.

## 🔓 Duolingo lesson + reward, CAPTURED

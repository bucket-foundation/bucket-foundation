# Bucket Learning — Cross-Pillar Deep Research Plan
...
tiers, AI (especially art) leveraged fully. Pilot domain = biophysics.
...
## Pillar mandates (each → `learning/research/<pillar>/`)
...
## Synthesis (Nucleus, after all 7 return)

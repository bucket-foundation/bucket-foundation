...
- **Steal:** spaced repetition works (active recall + spacing = the two
...
- **Steal:** the **skill tree** (a visible path, units open in order); **streaks** +
...
Bucket's unfair advantages.

1. **A curated dependency graph of foundations** (the nucleus), a level above a flat card pile,
 you always know *why* you're learning this and *what it opens*.
...
| **Quiz from corpus** | Generate exam-style questions from frontier papers | Frontier material stays current |
...
Scope: P0 is days; P1 is the real product; P2/P3 are roadmap. Start P0 against the

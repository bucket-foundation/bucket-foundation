...
**optimal nucleus** of each field, the smallest set of load-bearing ideas that open up
The most adjacent understanding, and chain those nuclei into **polymathy**.

---

## 1. The thesis: learn the *nucleus* rather than the textbook
...
> graph of foundations**, ranked by reach. That is the differentiator.
...
| # | Branch | Nucleus examples (high-reach core) |
|---|--------|----------------------------------------|
...
Note: the *engine* (FSRS scheduler, quiz generation, AI tutor, art generation) is

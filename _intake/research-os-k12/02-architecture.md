...
| `primary_source` | A citable artifact: paper, primary document, dataset, recording | any | no (cited, unmastered) |
...
### 2.5 Storage choice: Postgres or Neo4j or a combination
...
|---|---|---|---|
| **Access** | The learner can reach the node: prerequisites are unlocked, content exists in their language, their device tier can render it, age-gating passes | Binary eligibility check, no AI call | (implicit, unmodeled) |
...
### 3.5 Knowledge tracing: IRT/Elo x FSRS over BKT or DKT

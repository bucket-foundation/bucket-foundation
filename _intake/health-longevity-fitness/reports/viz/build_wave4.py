...
def arrowdefs():
    out="".join(f'<marker id="{n}" markerWidth="12" markerHeight="12" refX="8.5" refY="4" orient="auto" markerUnits="userSpaceOnUse"><path d="M0,0 L10,4 L0,8 Z" fill="{c}"/></marker>' for n,c in [("ah",ds.GOLD_D),("ag","#1d6b2e"),("ab","#3a6ea5")])
...
def pain_biopsychosocial():
    W,H=860,640
    head,y0,foot=ds.panel(W,H,"Pain · the modern model","Pain is biopsychosocial",
    ...
    s.append(ds.text(W/2,H-58,"Why staying active plus education beats bed rest, scans, and most surgery for back pain.",size=11,fill=ds.INK,font=ds.BODY,weight="600",anchor="middle"))

...
- **Lectures on Gas Theory -  Ludwig Boltzmann, Stephen G. Brush**
  ...
  -  … Indeed, <<Maxwell>> speaks with the greatest respect of Wilhelm Weber’s theory, 
which by determining the conversion factor of electrostatic and <<electromagnetic>> units and … 
- **A treatise on electricity and magnetism**
...
- **Optimize Your Health in the Modern World with Dr. Jack Kruse Ep. 1 (WiM544)**
  ...
  -  … other who described that in the
1860s <<Maxwell>> those are <<Maxwell>>'s laws
yeah for <<electromagnetism>> in physics
textbooks when you open them up … 
...
- **A <<treatise>> on <<electricity>> and magnetism**
  - `archive/electricandmagne01maxwrich/electricandmagne01maxwrich_djvu.txt`
  -  … For  the  experiments  which  established  this  principle,  see … 
- **Isaac Newton**
...
- **Kruse Canon Targets — Curated from 3 Transcripts (12hr+)**
  ...
  -  … clerk` | <<Maxwell>> | *<<Treatise>> on <<Electricity>> & Magnetism … 
...
**Concepts**: <<electromagnetic>>(22), AGE(14), iron(12), Becker(12 … 
...
- **Energy and Epigenetics 8: Quantum Autism**
  ...
  -  … <<electric>> field and/or the magnetic field currents in our body, generated by our brain or syncytium of cells along with the native <<electromagnetic>> … 

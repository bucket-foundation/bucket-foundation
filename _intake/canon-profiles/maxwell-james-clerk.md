...
and  from  the  laws  of  the  <<electromagnetic>>  field  alone 

-  r“  =  0  •  •  •  (20) 

In  <<Maxwell>>’s  theory  has  the  form 
...
describe  <<electrical>>  and  <<electromagnetic>>  phenomena.  These 
include  the  Ostrogradsky-Gauss  theorem  (18.3.3 … 
- **The scientific papers of James Clerk Maxwell**
  - `archive/scientificpapers01maxw/info.md`
  - # The scientific papers of James Clerk <<Maxwell>>

- **Archive identifier**: `scientificpapers01maxw`
- **URL**: https://archive.org/details/scientificpapers01maxw
- **Creator**: <<Maxwell>>, James Clerk, 1831-1879, Nivin, William … 
...
- **Per-Video References**
  ...
  -  … AGE(47), WHO(41), AGEs(13), EPA(11), magnetic field(6), <<electromagnetic>>(6), RAGE(6), Einstein(4), iron(2), quantum(2), <<Maxwell>>(2), Faraday … 
...
- **Albert Einstein**
  ...
  -  … require energy initially because they happen naturally based upon <<Maxwell>>’s laws of <<electromagnetism>>, <<Einstein>>’s <<photoelectric>> effect … 
- **Per-Video References**
  - `_intake/kruse-references … 
...
- **TENSEGRITY #5: YOUR MAGNETIC SENSE**
  ...
  -  … <<Maxwell>>’s equations show anytime we have an <<electric>> current we must have an associated magnetic field at 90 degrees. You may not see … 
- **Energy and Epigenetics 10: The Quantum Puzzle**
  - `_intake/kruse-blog-corpus/articles/energy-epigenetics-10-quantum-puzzle.md`
  -  … It creates the ability for a “<<Maxwell>> demon” to even exist. Because the electron is charged, it can be controlled by the <<electromagnetic>> force … 
- **Energy and Epigenetics 11: Is the Force With You?**
  - `_intake/kruse-blog-corpus/articles/energy-epigenetics-11-force.md`
  -  … semiconductors  in water to form an <<electric>> circuit.  If you carefully watch the [video on the <<electromagnetic>> force, ](http://www.youtube.com/watch?v … 
- **AGEs-RAGE-glycation**
  - `_intake/concept-digests/AGEs-RAGE-glycation.md`
  -  … <<maxwell>>-james-clerk.md`
  -  … 65), <<AGE>>(35), NAD(20), Rockefeller(9), iron(5), <<AGEs>>(5), Einstein(3), <<<<Maxwell>>>>(3), blue light(2), <<<<electromagnetic>>>>(2 … 
- **TENSEGRITY #12:  THE QUANTUM CELL MEMBRANE**
  - `_intake/kruse-blog-corpus/articles/tensegrity-12-quantum-cell-membrane.md`
  -  … The laws of <<electromagnetic>> induction were set forth by Faraday and formalized mathematically by <<Maxwell>>. <<Maxwell>> reasoned that moving charges in a wire would … 
- **TENSEGRITY # 4:  MAGNETISM, SLEEP, AND ELECTRONS**
  - `_intake/kruse-blog-corpus/articles/tensegrity-4-magnetism-electrons-sleep.md`
  -  … means there must be an associated <<electric>> field.  This is required by <<Maxwell>>’s laws of <<electromagnetism>>.  Furthermore, we all need to understand how … 
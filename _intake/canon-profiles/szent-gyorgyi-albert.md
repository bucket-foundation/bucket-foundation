...
Woods … 
- **Bioenergetics**
  - `archive/bioenergetics00szen/info.md`
  - # Bioenergetics

- **Archive identifier**: `bioenergetics00szen`
- **URL**: https://archive.org/details/bioenergetics00szen
- **Creator**: <<Szent-Györgyi>>, Albert, 1893-1986
- **Date**: 1957
...
- **Interactions of the two heads of scallop (Argopecten irradians) heavy meromyosin with actin: influence of calcium and nucleotides.**
  - `pubmed/PMID-12441001-interactions-of-the-two-heads-of-scallop-argopecten-irradian/info.md`
  -  … Miklos Nyitrai, Andrew G <<Szent-Györgyi>>, Michael A Geeves
- **MeSH**: Actins, Adenosine Diphosphate, Adenosine Triphosphate, Animals, Calcium, Mollusca, Muscle, Skeletal, Myosin Subfragments, Nucleotides, Protein … 
- **Ascorbate-quinone interactions: electrochemical, free radical, and cytotoxic properties.**
  - `pubmed/PMID-6296861-ascorbate-quinone-interactions-electrochemical-free-radical/info.md`
  -  … R Pethig, P R Gascoyne, J A McLaughlin, A <<Szent-Györgyi>>
- **MeSH**: Animals, Ascorbic Acid, Cell Survival, Electron Spin Resonance Spectroscopy, Female, Free Radicals … 
- **Water structure-dependent charge transport in proteins.**
  - `pubmed/PMID-6264436-water-structure-dependent-charge-transport-in-proteins/info.md`
  -  … P R Gascoyne, R Pethig, A <<Szent-Györgyi>>
- **MeSH**: Animals, Cattle, Chemical Phenomena, Chemistry, Physical, Electric Conductivity, Electron Transport, Mathematics, Proteins, Protons, Serum Albumin … 
- **Myosin cleft closure determines the energetics of the actomyosin interaction.**
  - `pubmed/PMID-20837775-myosin-cleft-closure-determines-the-energetics-of-the-actomy/info.md`
  -  … Balázs Takács, Elizabeth O'Neall-Hennessey, Csaba Hetényi, József Kardos, Andrew G <<Szent-Györgyi>>, Mihály Kovács
- **MeSH**: Actins, Actomyosin, Animals, Binding Sites, Calorimetry, Kinetics … 
- **Fluorescence measurements detect changes in scallop myosin regulatory domain.**
  - `pubmed/PMID-10215856-fluorescence-measurements-detect-changes-in-scallop-myosin-r/info.md`
  -  … A Málnási-Csizmadia, G Hegyi, F Tölgyesi, A G <<Szent-Györgyi>>, L Nyitray
- **MeSH**: Anilino Naphthalenesulfonates, Animals, Binding Sites, Calcium, Chromatography, Gel, Fluorescent Dyes … 

## youtube (3)

- **Lars Edvinsson's Opening Lecture of the Albert Szent-Györgyi Medical School**
  - `yt/hOMTiBqhbQc-lars-edvinsson-s-opening-lecture-of-the-albert-szent-gy-rgyi/transcript.txt`
  - good morning
i'm lars edwinson from sweden lund
university
professor lazar has been very
gracious and invited me to give in
a talk … 
- **Semester Opening Lecture at the Albert Szent-Györgyi Medical School**
  - `yt/oml8eX9aJhY-semester-opening-lecture-at-the-albert-szent-gy-rgyi-medical/transcript.txt`
  - so
unfortunately
the past two years we all had to face a
lifestreak and pandemic so but
we are optimistic and
we
are expecting … 
- **Isaac P. Witz, Ph.D Award Speech - 2023 Szent-Györgyi Prize**
  - `yt/_fDgW9M1NKo-isaac-p-witz-ph-d-award-speech-2023-szent-gy-rgyi-prize/transcript.txt`
  - good evening everybody so glad all of
...
("Ray Pete" → Ray Peat, "St Georgie" → <<Szent>> … 
...
- **Bucket Foundation — Research Mapping Queue**
  ...
  -  … UW Seattle. |
| `<<szent-gyorgyi>>-bioenergetics-1957` | Albert <<Szent-Györgyi>> — *Bioenergetics* (1957) + *Introduction to a Submolecular Biology* (1960) | Nobel laureate; Kruse's #1 cited foundational … 
- **fourth-phase-water**
...
- **Deuterium Depletion = Survival**
  ...
  -  … ATP, adenosine triphosphate, the biological energy necessary for all cellular function.”

**– <<Szent Gyorgyi>>**

![](https://jackkruse.com/wp-content/uploads/2019/07/Nobel_prize_1280x720 … 
...
- **Quantum Biology 5: COHERENT WATER = EZ WATER**
  ...
  -  … scientist Albert <<Szent-Gyorgyi>> had already highlighted the importance of water for life, and proposed that organized water existing ***close to surfaces***, such as … 
- **TENSEGRITY #7:  BLACK HOLE SUN,  HERE WE COME**
  - `_intake/kruse-blog-corpus/articles/tensegrity-7-black-hole-sun-come.md`
  -  … These ideas come directly from Gilbert Ling’s, Albert <<Szent Gyorgyi>>, and Stanley Prusiner’s work. This is why this blog could not come … 

...
- **The Jack Kruse Series 001**
  ...
  -  … michael <<faraday>>
<<electricity>>
isn't that what <<electricity>> is moving
electrons through a wire
yep now remember life
didn't know about <<faraday>>
you … 
- **Gerald Pollack| EZ Water, What is it, Why Do I Need It & How Do I Make It**
  ...
  -  … the Earth's <<electric>> field I said
Andre you're talking about <<magnetic>>
field I never heard of an <<electric>> field
he said you … 
- **Beyond DNA: The Electromagnetic Blueprint of Life - Jack Kruse, MD DSci Pod 187**
  ...
  -  … France who builds these crazy <<Faraday>>
...
- **REALITY# 8:  HOW WOMEN GAIN TIME AT MENOPAUSE**
  ...
  -  … <<Faraday>> in 1845, showed that light passing through a material will have its polarization rotated by the application of a <<magnetic>> field, a phenomenon … 
- **TENSEGRITY #11  EXOTIC ATOMS IN THE MATRIX**
  - `_intake/kruse-blog-corpus/articles/tensegrity-11-exotic-atoms-matrix.md`
  -  … s.   Maxwell also mathematized all of Michael <<Faraday>>’s observations from his experiments about <<electric>> and <<magnetic>> fields.  In 1864, [Maxwell ](http://en.wikipedia … 
...
- **TIME #7: THE PHOTOELECTRIC EFFECT**
  ...
  -  … Using optics and photonics, this simplifies <<electric>> and <<magnetic>> circuitry in cells to the low power state. Life at the cell level uses the … 
- **REALITY #1:   HOLES IN REALITY MAKE TIME**
  - `_intake/kruse-blog-corpus/articles/reality-1-holes-reality-make-time.md`
  -  … OF LIGHT? **

The <<Faraday>> effect generates <<magnetic>> fields in tissues when those proteins in the tissues are connected some way <<electrically>> as we explored … 
- **TIME #21:  SEMICONDUCTION REGENERATES TIME FOR CELLS**
  ...
  -  … of the DC <<electric>> current in cells. For the <<Faraday>> effect’s <<magnetic>>/optical properties to manifest, a local <<magnetic>> field (mitochondria)  must influence … 
- **ORGANIZATIONAL STRUCTURAL FAILURE #10:  MULTIPLE SCLEROSIS**
  ...
  -  … This has been shown <<experimentally>> in many labs. When the voltage gradient drops so does the <<electric>> and <<magnetic>> fields in and around mitochondria … 
- **REALITY 11:  OPTICS IN A NON LINEAR WORLD:  WHEN UV LIGHT CHANGED EARTH**
  ...
  -  … <<magnetic>> fields in media like stars and living tissues.  What affect controls this?  In cells this <<electric>> and <<magnetic>> ability is called the <<Faraday>> … 
...
**Concepts**: electromagnetic(22), AGE(14), iron(12), Becker(12), <<magnetic>> field(8), WHO(8), RAGE … 
...
- `0MmyVoqjkwQ-dr-jack-kruse-<<magnetism>>-and … 
- **Energy and Epigenetics 5: The Quantum Brain**
  ...
  -  … When an EMF is generated by a change in <<magnetic>> flux according to [<<Faraday>>’s Law](http://hyperphysics.phy-astr.gsu.edu/hbase/<<electric>> … 

...
**Query**: `<<circadian>> OR <<SCN>> OR <<suprachiasmatic>>`  ·  **Hits**: 25
...
- **PHYSICIAN GUEST BLOG #2:  THE INVISIBLE SUN IN THE GULF SOUTH**
  ...
  -  … It runs the master time-keeping organ of the body, the <<Suprachiasmatic>> Nucleus (<<SCN>>). There is a complex system of proteins and enzymes and … 
...
- **Cortisol Response**
  ...
  -  … controller of its release (ACTH).  Night time light stimulates the <<suprachiasmatic>> nucleus (<<SCN>>) and this sends a neural signal to the autonomic systems to … 
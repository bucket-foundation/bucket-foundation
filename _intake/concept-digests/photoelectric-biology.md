...
- **TIME #8:  PSORIASIS AND THE PHOTOELECTRIC EFFECT**
  ...
  -  … Surface action is a huge factor, and <<biology>> is completely missing this today because they do not understand these <<photoelectric>> interactions.  There is a … 
- **Energy and Epigenetics 13: Quantum Water Chemistry**
  ...
  -  … The link between electromagnetic signals and water

**An electron-rich <<body>> charge encourages oxygen to penetrate <<cells>>, prevents junk molecules from sticking to <<cell>> … 
- **Quantum Biology 12: Do We Need DNA To Tell Time?**
  ...
  -  … light and water where QED and Circadian <<biology>> collide?
...
- **TIME #12: IS ADRENAL FATIGUE DUE TO  AN ALTERED SPECTRUM OF LIGHT?**
  ...
  -  … in <<biology>>, we are suffering from the same problem today.

When the density is changed in <<cell>> water, this changes how the <<photoelectric>> effect … 
...
- **Energy and Epigenetics 2: The Real DHA Story**
  ...
  -  … Light quantizes <<biology>> because light controls all proteins and turns <<cell>> water into a massive <<photoelectric>> battery. This battery is capable of excluding all … 
...
**OPTICAL NEUROSURGERY OF CIRCADIAN <<BIOLOGY>>:**

...
**Query**: `photosynthesis AND quantum`  ·  **Hits**: 30
...
- **Weight Loss, Mitochondria Health & Vitamin D  with Dr. Jack Kruse**
  ...
  -  … is tied
to what <<photosynthesis>> do you think the
food web in food for mcdonald's is tied
to <<photosynthesis>> or was it created … 
...
- **UBIQUITINATION 20:  LINKING LIGHT TO PLANTS AND ANIMALS**
  ...
  -  … Today physicists know <<quantum>> mechanisms are at the core of what makes life special.  Moreover, in <<photosynthesis>> research, physicists have been floored that <<quantum>> … 
...
- **ORGANIZATION OF STRUCTURE AND FAILURE # 9:  DHA, STRESS, AND SCALE**
  - `_intake/kruse-blog-corpus/articles/organization-structure-failure-9-dha-stress-scale.md`
  -  … ANIMAL <<PHOTOSYNTHESIS>>](https://jackkruse.com/reality-15-animal-<<photosynthesis>>/)
...
![laserpatendiagramblock700](https://jackkruse.com/wp-content/uploads/2016/11/LaserPatenDiagramBlock700.jpg)
...
- **UBIQUITINATION 23: LOOKING BACK FOR A QUANTUM LEAP FORWARD**
  ...
  -  … Now you may be understanding why I recommend the books I do, to understand this very <<quantum>> process. **<<Photosynthesis>> happens at surfaces of leaves … 

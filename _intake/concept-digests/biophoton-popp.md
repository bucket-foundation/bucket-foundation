...
- **Ultraweak photon emission in assessing bone growth factor efficiency using fibroblastic differentiation.**
  - `pubmed/PMID-11705731-ultraweak-photon-emission-in-assessing-bone-growth-factor-ef/info.md`
  -  … Recent biophysical research has shown the induction of <<ultraweak photons>> in biological tissue. It is now established that plants, animal and human cells emit … 
...
- **Biological Electric Fields and Rate Equations for Biophotons**
  - `arxiv/1407.4689-biological-electric-fields-and-rate-equations-for-biophotons/info.md`
  - # Biological Electric Fields and Rate Equations for <<Biophotons>>
...
Source: https://jackkruse.com/time-for-<<biophotons>>/

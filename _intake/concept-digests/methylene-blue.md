...
- **PMCID**: PMC9898264 (full-text saved)
- **Journal**: Journal of orthopaedic translation  ·  **Year … 
...
- **Optimize Your Health in the Modern World with Dr. Jack Kruse Ep. 1 (WiM544)**
  ...
  -  … deficiency you can't use <<methylene
blue>> for that can we just talk about
what is <<methylene Blue>>'s role in this
mitochondrial function … 
- **DR. KRUSE: Your Body Was Designed for 500 Years Ago**
  - `yt/pKEOaE3VTJA-dr-kruse-your-body-was-designed-for-500-years-ago/transcript.txt`
  -  … I said,
"Well, if she would have known me then,
I would have told her about <<methylene
blue>> because <<methylene blue>> is the
precursor … 
...
and <<methylene blue>>
and things like
hypertonic saline solution would have
been the optimal choice for most of
those people … 
- **Dr. Jack Kruse: Reclaim Your Health, Wealth & Freedom in the Face of Medical Tyranny**
  ...
  -  … talk a little bit
about the
uh let's talk about <<methylene blue>>
because that's getting a lot of
attention recently um I … 
...
in the clinic, we usually have to give
them something called <<methylene blue>>.
And <<methylene blue>> unbinds the oxygen … 
...
- **Beyond DNA: The Electromagnetic Blueprint of Life - Jack Kruse, MD DSci Pod 187**
  ...
  -  … so I
just looked up the structure of
...
Source: https://jackkruse.com/biohacking-time-with-<<methylene-blue>>/
...
- **Michael Faraday**
  ...
  -  … When the voltage gradient drops so does the <<electric>> and <<magnetic>> fields in and around mitochondria … 
- **<<methylene-blue>>**
  - `_intake/concept-digests/<<methylene-blue>>.md … 
- **Fritz-Albert Popp**
...
- **<<methylene-blue>>**
  - `_intake/concept-digests/<<methylene-blue>>.md`
  -  … 30), Becker(26), <<<<methylene blue>>>>(21), electromagnetic … 
- **<<schumann>>-<<cme>>**
  - `_intake/concept … 
- **iron-heme-redox**
  - `_intake/concept-digests/iron-heme-redox.md`
  -  … heme>>-<<redox>>**
  - `_intake/concept-digests/<<iron>>-<<heme>>-<<redox>> … 
- **<<methylene-blue>>**
  - `_intake/concept-digests/<<methylene-blue>>.md`
  -  … It … 
- **<<iron>>-<<heme>>-<<redox>>**
  - `_intake/concept-digests/<<iron … 
- **Concept Digests**
  - `_intake/concept-digests/INDEX.md`
  -  … intake:14, openalex-citers:1, openalex-fanout:1, pubmed:19)
- [`<<methylene-blue>>`](<<methylene-blue>>.md) — 35 hits  (intake:16, openalex-citers:1, pubmed:11 … 
...
- **uv-uva-uvb**
  ...
  -  … wavelengths of <<UVA>>, with the small remainder <<UVB>> … 
- **<<methylene-blue>>**
  - `_intake/concept-digests/<<methylene-blue>>.md`

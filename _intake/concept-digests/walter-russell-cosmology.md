...
- **The Universal One 1926 Walter Russell**
  - `archive/the-universal-one-1926-walter-russell/info.md`
  - # The <<Universal>> One 1926 Walter <<Russell>>
...
- **#13 - Jack Kruse**
  ...
  -  … t dance around this we
see what just happened with Harvard
<<University>> see what happened with
Stanford you know during covid um we all … 
- **Dr. Jack Kruse: Silent Weapons for Silent Wars**
  - `yt/fVUJyK_y3KY-dr-jack-kruse-silent-weapons-for-silent-wars/transcript.txt`
  -  … Those are the ones
that actually control your circadian
...
- **Slug**: `<<russell>>-walter`
- **Canon branch**: 03-chemistry / lens
...
- **CPC #13:   HYPERFERRITIN CATARACT SYNDROME**
  ...
  -  … fatal flaw in modern cosmology when they speak about the expanding <<Universe>> discovered by Hubble’s red shift in his 1929 description.  We can … 

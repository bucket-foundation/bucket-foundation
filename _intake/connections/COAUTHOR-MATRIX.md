...
*Generated 2026-05-10 from 230 OpenAlex author publication graphs.*
...
|---|---|---:|
| Allen Newell | Herbert A. Simon | 33 |
...
| Geoffrey E. Hinton | Yuval Noah Harari | 2 |
| Yoshua Bengio | Demis Hassabis | 2 |

## Per-author top-N co-authors

- **Roger Penrose** → Stuart R. Hameroff(15), S. W. Hawking(11), N. David Mermin(1), Carlo Rovelli(1), Lisa Randall(1)
- **Isabelle Stengers** → Ilya Prigogine(31), Bruno Latour(3)
- **Herbert A. Simon** → Allen Newell(33), Marvin Minsky(1)
...
- **Yoshua Bengio** → Yann LeCun(13), Geoffrey E. Hinton(4), Demis Hassabis(2), Yuval Noah Harari(2), Daniel C. Dennett(1)
- **Geoffrey E. Hinton** → Ilya Sutskever(13), Yoshua Bengio(4), Yann LeCun(3), Yuval Noah Harari(2), Karl Friston(1)
...
- **bell hooks** → Cornel West(11), Judith Butler(3), Gilles Deleuze(1), Slavoj Žižek(1), Donna Haraway(1)
...
- **Sigmund Freud** → Carl Gustav Jung(3), Martín Heidegger(2), Jacques Lacan(2), Maurice Merleau-Ponty(2), Gilles Deleuze(1)
...
- **W. V. Quine** → Charles S. Peirce(2), Bruno Latour(1), Ian Hacking(1), Theodosius Dobzhansky(1), Francis Crick(1)
...
- **Lynn Margulis** → J. E. Lovelock(12), Marvin Minsky(2), Brian Goodwin(1)
- **Ilya Sutskever** → Geoffrey E. Hinton(13), Demis Hassabis(1)
- **Bruno Latour** → Isabelle Stengers(3), Donna Haraway(2), W. V. Quine(1), Ian Hacking(1), Theodosius Dobzhansky(1)
...
- **Ian Hacking** → Paul K. Feyerabend(2), Imre Lakatos(2), Michel Foucault(1), Bruno Latour(1), W. V. Quine(1)
- **Francis Crick** → Frederick Sanger(2), Bruno Latour(1), W. V. Quine(1), Ian Hacking(1), Theodosius Dobzhansky(1)
- **Jean Paul Sartre** → Simone de Beauvoir(8), Karl Jaspers(1), Michel Foucault(1), Linus Pauling(1)
- **Linus Pauling** → Albert Szent‐Györgyi(2), Bruno Latour(1), W. V. Quine(1), Ian Hacking(1), Theodosius Dobzhansky(1)
- **Paul K. Feyerabend** → Ian Hacking(2), Imre Lakatos(2), Bruno Latour(1), W. V. Quine(1), Theodosius Dobzhansky(1)
- **Claude Lévi‐Strauss** → Marshall Sahlins(4), Marcel Mauss(2), Martín Heidegger(1), Sigmund Freud(1), Maurice Merleau-Ponty(1)
- **Charles Darwin** → Alfred Russel Wallace(5), Konrad Lorenz(2), Loren C. Eiseley(2)
- **Theodosius Dobzhansky** → Bruno Latour(1), W. V. Quine(1), Ian Hacking(1), Francis Crick(1), Paul K. Feyerabend(1)
- **Jacques Lacan** → Sigmund Freud(2), Gilles Deleuze(2), Michel Foucault(2), Martín Heidegger(1), Maurice Merleau-Ponty(1)
- **Richard Rorty** → Hilary Putnam(2), Cornel West(2), Judith Butler(1), Slavoj Žižek(1), Donna Haraway(1)
...
- **Imre Lakatos** → Ian Hacking(2), Paul K. Feyerabend(2), Bruno Latour(1), W. V. Quine(1), Theodosius Dobzhansky(1)
...
- **Carl Gustav Jung** → Sigmund Freud(3), Hermann Hesse(1), Hannah Arendt(1), Martín Heidegger(1), Claude Lévi‐Strauss(1)
...
- **Anil K. Seth** → Karl Friston(6)
- **Slavoj Žižek** → Judith Butler(2), Donna Haraway(1), bell hooks(1), Richard Rorty(1), Friedrich Wilhelm Joseph von Schelling(1)
...
- **Yuval Noah Harari** → Geoffrey E. Hinton(2), Yoshua Bengio(2)
...
- **Marvin Minsky** → Lynn Margulis(2), Allen Newell(1), Herbert A. Simon(1)
...
- **Daniel C. Dennett** → Gilbert Ryle(1), Yoshua Bengio(1)
...
- **David J. Chalmers** → Yoshua Bengio(1)

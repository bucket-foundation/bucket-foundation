...
*Generated 2026-05-10 from 113 OpenAlex author publication graphs.*
...
| Charles S. Peirce | W. V. Quine | 2 |
| Ian Hacking | Paul K. Feyerabend | 2 |
| Ian Hacking | Imre Lakatos | 2 |
| Carlo Rovelli | Edward Witten | 2 |
| Richard P. Feynman | Steven Weinberg | 2 |
...
| Cumrun Vafa | Brian Greene | 2 |
| Martín Heidegger | Sigmund Freud | 2 |
| Maurice Merleau-Ponty | Sigmund Freud | 2 |
| Warren S. McCulloch | Albert Szent‐Györgyi | 2 |
| Antoine Laurent Lavoisier | Michael Faraday | 2 |
| Anton Zeilinger | Murray Gell‐Mann | 1 |
| Anton Zeilinger | Juan Maldacena | 1 |
| Anton Zeilinger | Stuart R. Hameroff | 1 |
| Alan H. Guth | Juan Maldacena | 1 |
| Juan Maldacena | S. W. Hawking | 1 |
| Juan Maldacena | Cumrun Vafa | 1 |
| Juan Maldacena | Nima Arkani–Hamed | 1 |
| Heinz von Foerster | Charles S. Peirce | 1 |
| Ian Hacking | Tim Maudlin | 1 |

## Per-author top-N co-authors

- **Roger Penrose** → Stuart R. Hameroff(15), S. W. Hawking(11), Lisa Randall(1), Lee Smolin(1), Carlo Rovelli(1)
...
- **Edward Witten** → Cumrun Vafa(8), Andrew Strominger(4), Juan Maldacena(3), Carlo Rovelli(2), Lisa Randall(1)
...
- **S. W. Hawking** → Roger Penrose(11), Andrew Strominger(4), Lee Smolin(1), Juan Maldacena(1)
...
- **Martín Heidegger** → Edmund Husserl(4), Maurice Merleau-Ponty(3), Sigmund Freud(2), Georg Wilhelm Friedrich Hegel(1), Carl Gustav Jung(1)
- **W. V. Quine** → Charles S. Peirce(2), Ian Hacking(1), Paul K. Feyerabend(1), Linus Pauling(1), Imre Lakatos(1)
- **Lisa Randall** → Nima Arkani–Hamed(3), Alan H. Guth(2), Lee Smolin(1), Roger Penrose(1), Carlo Rovelli(1)
- **Maurice Merleau-Ponty** → Edmund Husserl(3), Martín Heidegger(3), Sigmund Freud(2), Carl Gustav Jung(1)
...
- **Sigmund Freud** → Carl Gustav Jung(3), Maurice Merleau-Ponty(2), Martín Heidegger(2), Søren Kierkegaard(1)
- **Hilary Putnam** → Charles S. Peirce(5), Richard Rorty(2), Martha C. Nussbaum(1)
- **Ian Hacking** → Paul K. Feyerabend(2), Imre Lakatos(2), Tim Maudlin(1), W. V. Quine(1), Linus Pauling(1)
- **Edmund Husserl** → Martín Heidegger(4), Maurice Merleau-Ponty(3)
- **Murray Gell‐Mann** → Richard P. Feynman(5), Anton Zeilinger(1)
- **Linus Pauling** → Albert Szent‐Györgyi(2), W. V. Quine(1), Ian Hacking(1), Paul K. Feyerabend(1), Imre Lakatos(1)
- **Paul K. Feyerabend** → Ian Hacking(2), Imre Lakatos(2), W. V. Quine(1), Linus Pauling(1)
- **Anil K. Seth** → Karl Friston(6)
- **Karl Friston** → Anil K. Seth(6)
- **Georg Wilhelm Friedrich Hegel** → Friedrich Wilhelm Joseph von Schelling(5), Martín Heidegger(1)
- **Imre Lakatos** → Ian Hacking(2), Paul K. Feyerabend(2), W. V. Quine(1), Linus Pauling(1)
...
- **Carl Gustav Jung** → Sigmund Freud(3), Maurice Merleau-Ponty(1), Martín Heidegger(1)
- **Charles Darwin** → Alfred Russel Wallace(4)
- **Alfred Russel Wallace** → Charles Darwin(4)
...
- **Stephen Wolfram** → Roger Penrose(1), Stuart Kauffman(1)
- **Ludwig Wittgenstein** → W. V. Quine(1), Alfred North Whitehead(1)

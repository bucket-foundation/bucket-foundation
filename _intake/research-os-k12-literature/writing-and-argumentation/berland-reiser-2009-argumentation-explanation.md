...
url: "https://doi.org/10.1002/sce.20286"
openalex_id: "https://openalex.org/W2031885725"
...
how_it_bears_on_research_os: >
  Names, more precisely than any other card in this batch, the exact gap a Production
  submission's claim-plus-evidence structure leaves: sensemaking and articulating are the
  goals Locate, Quote, Check, and a written claim already target, but persuading, defending
  an understanding against another person's challenge, has no analog in the current
  four-tool design. Extends overlap-map question 5 and sharpens Osborne (2010,
  `osborne-2010-arguing-to-learn.md`)'s own collaborative-discourse case into a specific,
  named third goal `LEARNER-STATE-MODEL.md`'s Production rubric does not currently score for.
---
...
- What a persuading-goal component would look like inside a constrained four-tool workspace
  without reopening it to open-ended peer debate.

## How It Bears on Research OS

Names, more precisely than any other card in this batch, the exact gap a Production's
claim-plus-evidence structure leaves: sensemaking and articulating are already targeted, but
persuading, defending an understanding against challenge, has no analog in the four-tool
design. Extends overlap-map question 5 and sharpens Osborne (2010)'s collaborative-discourse
case into a specific, named third goal the Production rubric does not currently score for.

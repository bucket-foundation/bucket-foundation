...
url: "https://doi.org/10.1207/s15327019eb1103_2"
openalex_id: "https://openalex.org/W1995742667"
branch: "student-research-experiences"
tier: "canon"
why_it_matters: >
  A decade-spanning review finding contextual factors, especially a student's perception
  of peers' own cheating, predict academic dishonesty more than individual factors do, and
  that an institution's own integrity policies measurably change student behavior, a
  direct lever for the provenance guard `PLAN-REVISION-3.md` section 2b already scopes
  against Grinnell and colleagues (2020)'s misconduct finding.
key_claims:
  ...
  - "An institution's own academic-integrity programs and policies, honor codes among
    them, are found to have a measurable influence on students' cheating behavior, a
    policy-level lever distinct from any individual student's own disposition."
research_questions_it_leaves_open:
  - "Whether the peer-perception mechanism this review names as the strongest predictor
    of cheating has an analog in a Research OS classroom: whether a learner's belief about
    how common Production-provenance flags are among classmates predicts their own
    citation behavior."
  - "Whether an honor-code-style policy, publicly stated and consistently enforced, would
    ...
    among required, uninterested science-fair participants, a policy lever this review
    names as effective in the general case but that neither Grinnell and colleagues nor
    any current Research OS document tests directly."
how_it_bears_on_research_os: >
  Broadens the mechanism behind `PLAN-REVISION-3.md` section 2b's own provenance guard
...
- An institution's own academic-integrity programs and policies, honor codes among them,
  ...
  lever distinct from any individual student's own disposition.

## Research Questions It Leaves Open

- Whether the peer-perception mechanism this review names as the strongest predictor of
...
- Whether an honor-code-style policy, publicly stated and consistently enforced, would <!-- voice-ignore-line: the qualifier states how strong the finding is -->
  ...
  current Research OS document tests directly.

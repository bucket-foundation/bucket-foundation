...
url: "https://doi.org/10.3102/00346543075003285"
openalex_id: "https://openalex.org/W2158616698"
...
research_questions_it_leaves_open:
  ...
  - "What has changed, and what has not, between this review's 2005-era account of children's web search strategies and a present-day K-12 learner's own search behavior, given the review's own empirical base predates any AI-mediated search tool."
how_it_bears_on_research_os: >
  The earliest, most direct K-12-specific precedent in this batch for the Locate/Quote design
  itself: this review's own conclusion, that students need explicit support in both searching
  and developing information literacy, is close to a founding statement of the problem
  Locate and Quote's no-model-call retrieval design is built to solve, read two decades before
  the AI-specific evidence Wineburg and McGrew (2019, `wineburg-mcgrew-2019-lateral-
  reading.md`) and Breakstone and colleagues (2021, `breakstone-et-al-2021-civic-online-
  reasoning-national-portrait.md`) supply. Extends overlap-map question 1's cognitive-
  offloading concern to the specific search-and-source-evaluation subtask, with the review's
  own closing call, that web use should be studied for whether it builds deep and meaningful
  knowledge, matching the exact standard `LEARNER-STATE-MODEL.md`'s Understanding state is
  meant to hold Production submissions to.
---

# The Web as an Information Resource in K-12 Education
...
- Whether the search-support and information-literacy-support distinction maps onto Research
  OS's own Locate-versus-Check split, or cuts across that tool boundary.
- What has changed, and what has not, between this review's 2005-era account of children's
  web search strategies and present-day K-12 search behavior, given its empirical base
  predates any AI-mediated search tool.

## How It Bears on Research OS

The earliest, most direct K-12-specific precedent in this batch for the Locate/Quote design:
the conclusion that students need explicit support in both searching and information literacy

...
why_it_matters: >
  ...
  prior knowledge. Directly challenges the premise that having K-12 students "do research"
  with reduced instructional guidance produces learning gains, unless the guidance removed is
...
how_it_bears_on_research_os: >
  The central complicating case for overlap-map question 1 and question 10, and for the
...
- Whether a scoped, tool-mediated guidance form, such as Research OS's four constrained
  tools, counts as the guided instruction this paper argues for or the minimally guided
  instruction it argues against, since its own contrast is built around human-delivered
  instruction.
- What prior-knowledge threshold, if any, a K-12 learner needs before a reduced-guidance
  workspace stops carrying the risk this paper documents.
...
Cross-indexed against: `project-based-inquiry-learning/hmelo-silver-duncan-chinn-2007-scaffolding-response.md`.

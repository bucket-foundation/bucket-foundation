---
title: "Project Based Learning & Student Achievement: What Does the Research Tell Us? PBL Evidence Matters, Volume 1, No. 1"
authors:
  - "Kingston, Sally"
year: 2018
venue: "Buck Institute for Education (PBLWorks)"
doi: null
url: "https://eric.ed.gov/?id=ED590832"
eric_id: "ED590832"
openalex_id: null
branch: "project-based-inquiry-learning"
tier: "candidate"
why_it_matters: >
  A practitioner-facing evidence brief summarizing 20 studies of project-based learning's
  effect on student outcomes, published by the field's own leading PBL professional-
  development organization. A research brief rather than a peer-reviewed article, carrying no
  Crossref DOI; verified against its ERIC record (ED590832), the same non-DOI handling this
  batch applies to Condliffe (2017). Useful precisely because it is the kind of accessible,
  citable evidence summary a funder-facing narrative can point to directly.
key_claims:
  - "The brief reviews 20 studies addressing whether project-based learning affects student learning in core content areas, finding PBL can promote student learning in social studies and science, and to a more limited degree in mathematics and literacy."
...
how_it_bears_on_research_os: >
  ...
  `FAST-FORWARD-2026.md`'s own funding narratives need to point to when making the case that
  research-based, project-based pedagogy has real backing: this brief is the PBL field's own
...
A practitioner-facing evidence brief from the Buck Institute for Education (PBLWorks),
reviewing 20 studies of project-based learning's effect on student outcomes. A research brief
rather than a peer-reviewed article; carries no Crossref DOI, verified against its ERIC
record (ED590832).
...
- Whether a comparable practitioner-facing brief summarizing Research OS's own pilot
  findings is a worthwhile deliverable once Phase 1 data exists.

## How It Bears on Research OS

A direct model for the accessible, citable evidence summary the funding narratives need when

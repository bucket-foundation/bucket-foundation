...
## 1. Arielle Jackson's Purpose / Position / Personality Framework
...
**Amazon's Early Positioning (example)**:
...
2. Write a short paragraph personifying your company
3. Create a voice guide using this calibration template:

| Version | Description |
|---------|-------------|
| **Boring** | Standard, functional statement |
| **Without attribute** | Completely stripped of one quality |
| **Too much** | Attribute taken to extreme |
| **Just right** | Perfect balance of the attribute |

**eero Example** (applying "cleverness"):
- Boring: "WiFi coverage throughout your home"
- Without cleverness: "Fast and reliable WiFi in every room"
- Too much: "Awesome WiFi all up in your crib"
- Just right: "WiFi from the window to the wall" (references Lil Jon but works standalone)

**eero's three traits**: Clever, deliberate, approachable

---

## 2. Arielle Jackson's Positioning Deep-Dive

Source: [First Round Review](https://review.firstround.com/positioning-your-startup-is-vital-heres-how-to-do-it-right/)

### Key Questions Before Writing a Positioning Statement

- What makes your product/service functionally different?
...
|----------|-------------|----------|
| **Descriptive** | Explicit about function | Whole Foods, PayPal |
| **Suggestive** | Uses metaphor to evoke meaning | Amazon, Mint |
| **Fanciful** | No direct connection to offering | Apple, Adobe |

### Naming Exercise Steps

1. Create three buckets (descriptive, suggestive, fanciful)
2. Extract nouns and verbs from your positioning statement
...
A one-to-two page document containing:

- **Background**: Company/product name, description, value created, launch timeline
- **Audience**: Demographics + detailed model customer profile
- **Positioning**: Your statement (no frills)
- **Competitive audit**: 5-10 competitor companies with primary competitor highlighted
- **Messaging**: Key takeaways and tagline
- **Current perception**: How market currently sees you
- **Brand attributes**: Personality descriptors
- **Inspiration**: Examples of brands/designs you admire and why
- **Deliverables**: Logo, website, video, etc.
- **Delivery date**: Firm deadlines
- **Budget**: Realistic costs
- **Sign-off**: One person with approval authority
...
1. **Create**: Generate 1,000-1,500 name candidates
2. **Invent**: Develop strategic variations
3. **Implement**: Validate and launch
...
- "B" suggests reliability (BlackBerry)
- "Z" captures attention (Azure)
- "X" signals innovation

### The Diamond Framework

Founders can sketch a diamond with four points:
- **Top (Win)**: Target outcome
- **Right**: Required competitive advantages
- **Bottom**: Necessary capabilities
- **Left**: Essential messaging

This shifts focus from word-hunting to defining desired behaviors and experiences.

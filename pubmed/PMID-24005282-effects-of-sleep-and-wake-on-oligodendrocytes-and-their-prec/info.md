...
- **PMCID**: PMC3160719 (full-text saved)
- **Journal**: The Journal of neuroscience : the official journal of the Society for Neuroscience  ·  **Year**: 2013
- **Authors**: Michele Bellesi, Martha Pfister-Genskow, Stephanie Maret, Sunduz Keles, Giulio Tononi, Chiara Cirelli
- **MeSH**: Animals, Apoptosis, Cell Proliferation, Gene Expression Profiling, Genome, Mice, Mice, Transgenic, Neural Stem Cells, Oligodendroglia, RNA, Messenger
- **URL**: https://pubmed.ncbi.nlm.nih.gov/24005282/
- **Captured**: 2026-05-10T16:16:12

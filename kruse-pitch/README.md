...
**Framing**: collaboration. We respect his corpus enough to have already built a useful thing on it; we want to maintain it for him and for his community.
...
I run a small venture studio (AG Farms) and a nonprofit-in-formation called **Bucket Foundation** (bucket.foundation). Bucket's mission is simple: make primary research paid-for-once and citeable-forever, with citation fees routed to authors. Our canon holds only foundations, axioms, rules, laws, principles, across seven branches (mathematics, physics, chemistry, information, biophysics, cosmology, mind). Your work is one of the partial sources we've leaned on in the biophysics branch.
...
- v4 (this file): about what DerbyFish captures today + what we're adding, ⏳ awaiting artifacts + founder review
